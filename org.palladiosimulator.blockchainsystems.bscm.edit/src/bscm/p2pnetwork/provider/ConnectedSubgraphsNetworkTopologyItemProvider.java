...
/**
 * This is the item provider adapter for a {@link bscm.p2pnetwork.ConnectedSubgraphsNetworkTopology} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectedSubgraphsNetworkTopologyItemProvider extends ConstraintNetworkTopologyItemProvider {
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ConnectedSubgraphsNetworkTopology_type") :
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(P2pnetworkPackage.Literals.CONNECTED_SUBGRAPHS_NETWORK_TOPOLOGY__SUBGRAPHS,
				 P2pnetworkFactory.eINSTANCE.createSubgraphSpecification()));

		newChildDescriptors.add
			(createChildParameter
				(P2pnetworkPackage.Literals.CONNECTED_SUBGRAPHS_NETWORK_TOPOLOGY__SUBGRAPH_LINKS,
