...
/**
 * This is the item provider adapter for a {@link bscm.p2pnetwork.SubgraphLink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubgraphLinkItemProvider extends EntityItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SubgraphLink_ConnectedSubgraphs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SubgraphLink_ConnectedSubgraphs_feature", "_UI_SubgraphLink_type"),
				 P2pnetworkPackage.Literals.SUBGRAPH_LINK__CONNECTED_SUBGRAPHS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(P2pnetworkPackage.Literals.SUBGRAPH_LINK__SPECIFICATION);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_SubgraphLink_type") :
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SubgraphLink.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(P2pnetworkPackage.Literals.SUBGRAPH_LINK__SPECIFICATION,
