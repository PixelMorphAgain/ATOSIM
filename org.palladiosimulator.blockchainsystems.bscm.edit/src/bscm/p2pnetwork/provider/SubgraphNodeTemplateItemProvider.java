...
/**
 * This is the item provider adapter for a {@link bscm.p2pnetwork.SubgraphNodeTemplate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubgraphNodeTemplateItemProvider extends EntityItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_SubgraphNodeTemplate_NumberOfNodeOccurences_feature", "_UI_SubgraphNodeTemplate_type"),
				 P2pnetworkPackage.Literals.SUBGRAPH_NODE_TEMPLATE__NUMBER_OF_NODE_OCCURENCES,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_SubgraphNodeTemplate_Allocation_feature", "_UI_SubgraphNodeTemplate_type"),
				 P2pnetworkPackage.Literals.SUBGRAPH_NODE_TEMPLATE__ALLOCATION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIsSubgraphProxyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SubgraphNodeTemplate_IsSubgraphProxy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SubgraphNodeTemplate_IsSubgraphProxy_feature", "_UI_SubgraphNodeTemplate_type"),
				 P2pnetworkPackage.Literals.SUBGRAPH_NODE_TEMPLATE__IS_SUBGRAPH_PROXY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_SubgraphNodeTemplate_type") :
