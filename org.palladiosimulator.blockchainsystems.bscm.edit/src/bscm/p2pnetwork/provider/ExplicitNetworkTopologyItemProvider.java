...
/**
 * This is the item provider adapter for a {@link bscm.p2pnetwork.ExplicitNetworkTopology} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExplicitNetworkTopologyItemProvider extends NetworkTopologyItemProvider {
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ExplicitNetworkTopology_type") :
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(P2pnetworkPackage.Literals.EXPLICIT_NETWORK_TOPOLOGY__NODES,
				 P2pnetworkFactory.eINSTANCE.createNode()));

		newChildDescriptors.add
			(createChildParameter
				(P2pnetworkPackage.Literals.EXPLICIT_NETWORK_TOPOLOGY__LINKS,
