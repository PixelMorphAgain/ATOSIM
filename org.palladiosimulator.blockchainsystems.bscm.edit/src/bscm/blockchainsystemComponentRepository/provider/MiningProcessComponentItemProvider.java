...
/**
 * This is the item provider adapter for a {@link bscm.blockchainsystemComponentRepository.MiningProcessComponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MiningProcessComponentItemProvider extends BlockchainSystemNodeComponentItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_MiningProcessComponent_IsMiningProcessEnabled_feature", "_UI_MiningProcessComponent_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_MiningProcessComponent_type") :
