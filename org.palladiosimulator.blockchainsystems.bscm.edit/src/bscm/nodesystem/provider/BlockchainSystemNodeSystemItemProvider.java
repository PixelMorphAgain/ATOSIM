/**
 */
package bscm.nodesystem.provider;
...
/**
 * This is the item provider adapter for a {@link bscm.nodesystem.BlockchainSystemNodeSystem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BlockchainSystemNodeSystemItemProvider extends EntityItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BlockchainSystemNodeSystem_MiningProcessAssembly_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BlockchainSystemNodeSystem_MiningProcessAssembly_feature", "_UI_BlockchainSystemNodeSystem_type"),
				 NodesystemPackage.Literals.BLOCKCHAIN_SYSTEM_NODE_SYSTEM__MINING_PROCESS_ASSEMBLY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_BlockchainSystemNodeSystem_BlockValidatorAssembly_feature", "_UI_BlockchainSystemNodeSystem_type"),
				 NodesystemPackage.Literals.BLOCKCHAIN_SYSTEM_NODE_SYSTEM__BLOCK_VALIDATOR_ASSEMBLY,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_BlockchainSystemNodeSystem_type") :
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NodesystemPackage.Literals.BLOCKCHAIN_SYSTEM_NODE_SYSTEM__ASSEMBLY_CONTEXTS,
				 NodesystemFactory.eINSTANCE.createBlockchainSystemNodeAssemblyContext()));

		newChildDescriptors.add
			(createChildParameter
				(NodesystemPackage.Literals.BLOCKCHAIN_SYSTEM_NODE_SYSTEM__BEHAVIOR,
