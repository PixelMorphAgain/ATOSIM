...
/**
 * This is the item provider adapter for a {@link bscm.blockchainsystem.BlockchainSystemSpecification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BlockchainSystemSpecificationItemProvider extends EntityItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BlockchainSystemSpecification_MeanBlockTime_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BlockchainSystemSpecification_MeanBlockTime_feature", "_UI_BlockchainSystemSpecification_type"),
				 BlockchainsystemPackage.Literals.BLOCKCHAIN_SYSTEM_SPECIFICATION__MEAN_BLOCK_TIME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_BlockchainSystemSpecification_NumOfRequiredSecurityConfirmations_feature", "_UI_BlockchainSystemSpecification_type"),
	...
	protected void addRequiredHashPowerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BlockchainSystemSpecification_RequiredHashPower_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BlockchainSystemSpecification_RequiredHashPower_feature", "_UI_BlockchainSystemSpecification_type"),
				 BlockchainsystemPackage.Literals.BLOCKCHAIN_SYSTEM_SPECIFICATION__REQUIRED_HASH_POWER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addMaxBlockSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BlockchainSystemSpecification_MaxBlockSize_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BlockchainSystemSpecification_MaxBlockSize_feature", "_UI_BlockchainSystemSpecification_type"),
				 BlockchainsystemPackage.Literals.BLOCKCHAIN_SYSTEM_SPECIFICATION__MAX_BLOCK_SIZE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_BlockchainSystemSpecification_type") :
