...
/**
 * This is the item provider adapter for a {@link bscm.blockchainsystem.BlockchainSystem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BlockchainSystemItemProvider extends EntityItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_BlockchainSystem_Network_feature", "_UI_BlockchainSystem_type"),
				 BlockchainsystemPackage.Literals.BLOCKCHAIN_SYSTEM__NETWORK,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BlockchainsystemPackage.Literals.BLOCKCHAIN_SYSTEM__TRANSACTIONS_SPECIFICATION);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_BlockchainSystem_type") :
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BlockchainsystemPackage.Literals.BLOCKCHAIN_SYSTEM__SPECIFICATION,
				 BlockchainsystemFactory.eINSTANCE.createBlockchainSystemSpecification()));

		newChildDescriptors.add
			(createChildParameter
				(BlockchainsystemPackage.Literals.BLOCKCHAIN_SYSTEM__TRANSACTIONS_SPECIFICATION,
