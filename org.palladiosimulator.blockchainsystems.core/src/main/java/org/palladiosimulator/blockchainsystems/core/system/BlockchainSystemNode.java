...
public class BlockchainSystemNode extends BlockchainSimulationObject implements Taggable {
	...
	public BlockchainSystemNode(
			...
			BlockFactory blockFactory,
			BlockchainSystemNodeBehavior behavior) {
		this(id, name, blockPropagationStrategy, networkInterface, miningProcess, blockchain, blockValidator,
				orphanBlockPool, blockFactory, behavior, Collections.emptySet());
	}
	...
	public void onInitialize() {
		...
		_blockPropagationStrategy.setOnBlockReceivedCallback(this::onBlockReceived);
