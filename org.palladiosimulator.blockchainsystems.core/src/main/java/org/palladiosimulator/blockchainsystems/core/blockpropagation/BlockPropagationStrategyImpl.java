...
public class BlockPropagationStrategyImpl extends BlockchainNodeObject implements BlockPropagationStrategy {
	...
	private static final String INV_MESSSAGE_KEY = "BlockInvMessage";
	...
	private MessageImpl createInvMessage(String hash) {
		return new MessageImpl(hash, INV_MESSSAGE_KEY, MESSAGE_HEADER_BYTE_SIZE + INV_MESSAGE_BYTE_SIZE);
	}
