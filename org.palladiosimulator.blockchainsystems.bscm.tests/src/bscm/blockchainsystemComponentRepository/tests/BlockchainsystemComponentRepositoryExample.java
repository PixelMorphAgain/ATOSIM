...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>blockchainsystemComponentRepository</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class BlockchainsystemComponentRepositoryExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.blockchainsystemcomponentrepository"));
				BlockchainSystemNodeComponentRepository root = BlockchainsystemComponentRepositoryFactory.eINSTANCE.createBlockchainSystemNodeComponentRepository();
...
} //BlockchainsystemComponentRepositoryExample
