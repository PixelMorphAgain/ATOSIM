...
public class ReliabilityExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.reliability"));
				HardwareInducedFailureType root = ReliabilityFactory.eINSTANCE.createHardwareInducedFailureType();
