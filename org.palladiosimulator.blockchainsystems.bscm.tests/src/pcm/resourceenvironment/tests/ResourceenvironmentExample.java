 ...
 * @generated
 */
public class ResourceenvironmentExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				...
				ResourceEnvironment root = ResourceenvironmentFactory.eINSTANCE.createResourceEnvironment();
