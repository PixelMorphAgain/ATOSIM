...
public class NodeenvironmentFactoryImpl extends EFactoryImpl implements NodeenvironmentFactory {
	...
	public static NodeenvironmentFactory init() {
		try {
			NodeenvironmentFactory theNodeenvironmentFactory = (NodeenvironmentFactory)EPackage.Registry.INSTANCE.getEFactory(NodeenvironmentPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case NodeenvironmentPackage.NODE_ENVIRONMENT: return createNodeEnvironment();
			case NodeenvironmentPackage.NODE_RESOURCE_CONTAINER: return createNodeResourceContainer();
			default:
