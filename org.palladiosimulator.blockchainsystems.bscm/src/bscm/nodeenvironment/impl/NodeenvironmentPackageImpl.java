...
public class NodeenvironmentPackageImpl extends EPackageImpl implements NodeenvironmentPackage {
	 ...
	 * @see bscm.nodeenvironment.NodeenvironmentPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static NodeenvironmentPackage init() {
		if (isInited) return (NodeenvironmentPackage)EPackage.Registry.INSTANCE.getEPackage(NodeenvironmentPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredNodeenvironmentPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		NodeenvironmentPackageImpl theNodeenvironmentPackage = registeredNodeenvironmentPackage instanceof NodeenvironmentPackageImpl ? (NodeenvironmentPackageImpl)registeredNodeenvironmentPackage : new NodeenvironmentPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEClass(nodeEnvironmentEClass, NodeEnvironment.class, "NodeEnvironment", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getNodeEnvironment_ResourceContainers(), this.getNodeResourceContainer(), null, "ResourceContainers", null, 0, -1, NodeEnvironment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(nodeResourceContainerEClass, NodeResourceContainer.class, "NodeResourceContainer", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNodeResourceContainer_ResourcePower(), theEcorePackage.getEDouble(), "ResourcePower", null, 1, 1, NodeResourceContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
