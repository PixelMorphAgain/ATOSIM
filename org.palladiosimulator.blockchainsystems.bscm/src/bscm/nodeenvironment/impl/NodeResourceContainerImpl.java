 ...
 * </p>
 * <ul>
 *   <li>{@link bscm.nodeenvironment.impl.NodeResourceContainerImpl#getResourcePower <em>Resource Power</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NodeResourceContainerImpl extends EntityImpl implements NodeResourceContainer {
	...
	public void setResourcePower(double newResourcePower) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NodeenvironmentPackage.NODE_RESOURCE_CONTAINER__RESOURCE_POWER, oldResourcePower, resourcePower));
	}
