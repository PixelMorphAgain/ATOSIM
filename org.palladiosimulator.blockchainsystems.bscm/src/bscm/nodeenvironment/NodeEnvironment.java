 ...
 * </p>
 * <ul>
 *   <li>{@link bscm.nodeenvironment.NodeEnvironment#getResourceContainers <em>Resource Containers</em>}</li>
 * </ul>
 *
 * @see bscm.nodeenvironment.NodeenvironmentPackage#getNodeEnvironment()
 * @model
 * @generated
 */
public interface NodeEnvironment extends Entity {
	 ...
	 * The list contents are of type {@link bscm.nodeenvironment.NodeResourceContainer}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Resource Containers</em>' containment reference list.
	 * @see bscm.nodeenvironment.NodeenvironmentPackage#getNodeEnvironment_ResourceContainers()
