...
public class BlockchainsystemPackageImpl extends EPackageImpl implements BlockchainsystemPackage {
	 ...
	 * @see bscm.blockchainsystem.BlockchainsystemPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static BlockchainsystemPackage init() {
		if (isInited) return (BlockchainsystemPackage)EPackage.Registry.INSTANCE.getEPackage(BlockchainsystemPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredBlockchainsystemPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		BlockchainsystemPackageImpl theBlockchainsystemPackage = registeredBlockchainsystemPackage instanceof BlockchainsystemPackageImpl ? (BlockchainsystemPackageImpl)registeredBlockchainsystemPackage : new BlockchainsystemPackageImpl();
	 ...
	 */
	@Override
	public EAttribute getBlockchainSystemSpecification_RequiredHashPower() {
	...
	public void createPackageContents() {
		...
		createEAttribute(blockchainSystemSpecificationEClass, BLOCKCHAIN_SYSTEM_SPECIFICATION__NUM_OF_REQUIRED_SECURITY_CONFIRMATIONS);
		createEAttribute(blockchainSystemSpecificationEClass, BLOCKCHAIN_SYSTEM_SPECIFICATION__REQUIRED_HASH_POWER);
		...
		createEAttribute(transactionsSpecificationEClass, TRANSACTIONS_SPECIFICATION__MEAN_TRANSACTION_CREATION_INTERVAL);
		createEReference(transactionsSpecificationEClass, TRANSACTIONS_SPECIFICATION__TRANSACTION_PROPERTIES_SPECIFICATION);
		...
		createEAttribute(transactionPropertiesSpecificationValueEClass, TRANSACTION_PROPERTIES_SPECIFICATION_VALUE__SIZE);
		createEAttribute(transactionPropertiesSpecificationValueEClass, TRANSACTION_PROPERTIES_SPECIFICATION_VALUE__FEE);
		createEAttribute(transactionPropertiesSpecificationValueEClass, TRANSACTION_PROPERTIES_SPECIFICATION_VALUE__PROBABILITY);
	}
	...
	public void initializePackageContents() {
		...
		P2pnetworkPackage theP2pnetworkPackage = (P2pnetworkPackage)EPackage.Registry.INSTANCE.getEPackage(P2pnetworkPackage.eNS_URI);
		...
		initEClass(blockchainSystemEClass, BlockchainSystem.class, "BlockchainSystem", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBlockchainSystem_Network(), theP2pnetworkPackage.getP2PNetwork(), null, "Network", null, 1, 1, BlockchainSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBlockchainSystem_Specification(), this.getBlockchainSystemSpecification(), null, "Specification", null, 1, 1, BlockchainSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBlockchainSystem_TransactionsSpecification(), this.getTransactionsSpecification(), null, "TransactionsSpecification", null, 1, 1, BlockchainSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(blockchainSystemSpecificationEClass, BlockchainSystemSpecification.class, "BlockchainSystemSpecification", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBlockchainSystemSpecification_MeanBlockTime(), theEcorePackage.getEDouble(), "MeanBlockTime", null, 1, 1, BlockchainSystemSpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBlockchainSystemSpecification_NumOfRequiredSecurityConfirmations(), theEcorePackage.getEInt(), "NumOfRequiredSecurityConfirmations", null, 1, 1, BlockchainSystemSpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBlockchainSystemSpecification_RequiredHashPower(), theEcorePackage.getEDouble(), "RequiredHashPower", null, 1, 1, BlockchainSystemSpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBlockchainSystemSpecification_MaxBlockSize(), theEcorePackage.getEInt(), "MaxBlockSize", null, 1, 1, BlockchainSystemSpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(transactionsSpecificationEClass, TransactionsSpecification.class, "TransactionsSpecification", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTransactionsSpecification_MeanTransactionCreationInterval(), theEcorePackage.getEDouble(), "MeanTransactionCreationInterval", null, 1, 1, TransactionsSpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTransactionsSpecification_TransactionPropertiesSpecification(), this.getTransactionPropertiesSpecification(), null, "TransactionPropertiesSpecification", null, 1, 1, TransactionsSpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(transactionPropertiesSpecificationEClass, TransactionPropertiesSpecification.class, "TransactionPropertiesSpecification", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTransactionPropertiesSpecification_Values(), this.getTransactionPropertiesSpecificationValue(), null, "Values", null, 1, -1, TransactionPropertiesSpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(transactionPropertiesSpecificationValueEClass, TransactionPropertiesSpecificationValue.class, "TransactionPropertiesSpecificationValue", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTransactionPropertiesSpecificationValue_Size(), theEcorePackage.getEDouble(), "Size", null, 1, 1, TransactionPropertiesSpecificationValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTransactionPropertiesSpecificationValue_Fee(), theEcorePackage.getEInt(), "Fee", null, 1, 1, TransactionPropertiesSpecificationValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTransactionPropertiesSpecificationValue_Probability(), theEcorePackage.getEDouble(), "Probability", null, 1, 1, TransactionPropertiesSpecificationValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
