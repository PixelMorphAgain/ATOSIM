 ...
 * </p>
 * <ul>
 *   <li>{@link bscm.nodeallocation.impl.NodeAllocationRepositoryImpl#getNodeAllocations <em>Node Allocations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NodeAllocationRepositoryImpl extends EntityImpl implements NodeAllocationRepository {
	...
	public EList<NodeAllocation> getNodeAllocations() {
		if (nodeAllocations == null) {
			nodeAllocations = new EObjectContainmentEList<NodeAllocation>(NodeAllocation.class, this, NodeallocationPackage.NODE_ALLOCATION_REPOSITORY__NODE_ALLOCATIONS);
		}
