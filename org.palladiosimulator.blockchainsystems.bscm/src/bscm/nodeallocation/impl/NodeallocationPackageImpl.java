...
public class NodeallocationPackageImpl extends EPackageImpl implements NodeallocationPackage {
	 ...
	 * @see bscm.nodeallocation.NodeallocationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static NodeallocationPackage init() {
		if (isInited) return (NodeallocationPackage)EPackage.Registry.INSTANCE.getEPackage(NodeallocationPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredNodeallocationPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		NodeallocationPackageImpl theNodeallocationPackage = registeredNodeallocationPackage instanceof NodeallocationPackageImpl ? (NodeallocationPackageImpl)registeredNodeallocationPackage : new NodeallocationPackageImpl();
	 ...
	 */
	@Override
	public EReference getNodeAllocation_NodeGeographicalEnvironment() {
	 ...
	 */
	@Override
	public EReference getNodeAllocationContext_NodeGeographicalRegionSpecification() {
		return (EReference)nodeAllocationContextEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(nodeAllocationEClass, NODE_ALLOCATION__NODE_GEOGRAPHICAL_ENVIRONMENT);
		...
		createEReference(nodeAllocationContextEClass, NODE_ALLOCATION_CONTEXT__NODE_GEOGRAPHICAL_REGION_SPECIFICATION);
	}
	...
	public void initializePackageContents() {
		...
		NodeenvironmentPackage theNodeenvironmentPackage = (NodeenvironmentPackage)EPackage.Registry.INSTANCE.getEPackage(NodeenvironmentPackage.eNS_URI);
		NodesystemPackage theNodesystemPackage = (NodesystemPackage)EPackage.Registry.INSTANCE.getEPackage(NodesystemPackage.eNS_URI);
		NodegeographicalenvironmentPackage theNodegeographicalenvironmentPackage = (NodegeographicalenvironmentPackage)EPackage.Registry.INSTANCE.getEPackage(NodegeographicalenvironmentPackage.eNS_URI);
		...
		initEClass(nodeAllocationEClass, NodeAllocation.class, "NodeAllocation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getNodeAllocation_AllocationContexts(), this.getNodeAllocationContext(), null, "AllocationContexts", null, 0, -1, NodeAllocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNodeAllocation_NodeAllocationEnvironment(), theNodeenvironmentPackage.getNodeEnvironment(), null, "NodeAllocationEnvironment", null, 1, 1, NodeAllocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNodeAllocation_NodeSystem(), theNodesystemPackage.getBlockchainSystemNodeSystem(), null, "NodeSystem", null, 1, 1, NodeAllocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNodeAllocation_NodeGeographicalEnvironment(), theNodegeographicalenvironmentPackage.getNodeGeographicalEnvironment(), null, "NodeGeographicalEnvironment", null, 1, 1, NodeAllocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(nodeAllocationRepositoryEClass, NodeAllocationRepository.class, "NodeAllocationRepository", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getNodeAllocationRepository_NodeAllocations(), this.getNodeAllocation(), null, "NodeAllocations", null, 0, -1, NodeAllocationRepository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(nodeAllocationContextEClass, NodeAllocationContext.class, "NodeAllocationContext", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getNodeAllocationContext_AssemblyContext(), theNodesystemPackage.getBlockchainSystemNodeAssemblyContext(), null, "AssemblyContext", null, 1, 1, NodeAllocationContext.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNodeAllocationContext_ResourceContainer(), theNodeenvironmentPackage.getNodeResourceContainer(), null, "ResourceContainer", null, 1, 1, NodeAllocationContext.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNodeAllocationContext_NodeGeographicalRegionSpecification(), theNodegeographicalenvironmentPackage.getNodeGeographicalRegionSpecification(), null, "NodeGeographicalRegionSpecification", null, 1, 1, NodeAllocationContext.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
