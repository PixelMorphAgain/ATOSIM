...
public class NodeallocationFactoryImpl extends EFactoryImpl implements NodeallocationFactory {
	...
	public static NodeallocationFactory init() {
		try {
			NodeallocationFactory theNodeallocationFactory = (NodeallocationFactory)EPackage.Registry.INSTANCE.getEFactory(NodeallocationPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case NodeallocationPackage.NODE_ALLOCATION: return createNodeAllocation();
			case NodeallocationPackage.NODE_ALLOCATION_REPOSITORY: return createNodeAllocationRepository();
			case NodeallocationPackage.NODE_ALLOCATION_CONTEXT: return createNodeAllocationContext();
			default:
