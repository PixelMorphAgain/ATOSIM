 ...
 * </p>
 * <ul>
 *   <li>{@link bscm.nodeallocation.NodeAllocationRepository#getNodeAllocations <em>Node Allocations</em>}</li>
 * </ul>
 *
 * @see bscm.nodeallocation.NodeallocationPackage#getNodeAllocationRepository()
 * @model
 * @generated
 */
public interface NodeAllocationRepository extends Entity {
	 ...
	 * The list contents are of type {@link bscm.nodeallocation.NodeAllocation}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Node Allocations</em>' containment reference list.
	 * @see bscm.nodeallocation.NodeallocationPackage#getNodeAllocationRepository_NodeAllocations()
