 ...
 * </p>
 * <ul>
 *   <li>{@link bscm.p2pnetwork.impl.ExplicitNetworkTopologyImpl#getNodes <em>Nodes</em>}</li>
 *   <li>{@link bscm.p2pnetwork.impl.ExplicitNetworkTopologyImpl#getLinks <em>Links</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExplicitNetworkTopologyImpl extends NetworkTopologyImpl implements ExplicitNetworkTopology {
	...
	public EList<Node> getNodes() {
		if (nodes == null) {
			nodes = new EObjectContainmentEList<Node>(Node.class, this, P2pnetworkPackage.EXPLICIT_NETWORK_TOPOLOGY__NODES);
		}
		return nodes;
	}
	...
	public EList<Link> getLinks() {
		if (links == null) {
			links = new EObjectContainmentEList<Link>(Link.class, this, P2pnetworkPackage.EXPLICIT_NETWORK_TOPOLOGY__LINKS);
		}
		return links;
	}
