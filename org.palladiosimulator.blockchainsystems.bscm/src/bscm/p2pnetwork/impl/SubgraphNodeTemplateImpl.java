 ...
 * </p>
 * <ul>
 *   <li>{@link bscm.p2pnetwork.impl.SubgraphNodeTemplateImpl#getNumberOfNodeOccurences <em>Number Of Node Occurences</em>}</li>
 *   <li>{@link bscm.p2pnetwork.impl.SubgraphNodeTemplateImpl#getAllocation <em>Allocation</em>}</li>
 *   <li>{@link bscm.p2pnetwork.impl.SubgraphNodeTemplateImpl#isIsSubgraphProxy <em>Is Subgraph Proxy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubgraphNodeTemplateImpl extends EntityImpl implements SubgraphNodeTemplate {
	...
	public void setNumberOfNodeOccurences(int newNumberOfNodeOccurences) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, P2pnetworkPackage.SUBGRAPH_NODE_TEMPLATE__NUMBER_OF_NODE_OCCURENCES, oldNumberOfNodeOccurences, numberOfNodeOccurences));
	}
	...
	public NodeAllocation getAllocation() {
		if (allocation != null && allocation.eIsProxy()) {
			...
			if (allocation != oldAllocation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, P2pnetworkPackage.SUBGRAPH_NODE_TEMPLATE__ALLOCATION, oldAllocation, allocation));
			}
		}
		return allocation;
	}
	...
	public void setAllocation(NodeAllocation newAllocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, P2pnetworkPackage.SUBGRAPH_NODE_TEMPLATE__ALLOCATION, oldAllocation, allocation));
	}
	...
	public void setIsSubgraphProxy(boolean newIsSubgraphProxy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, P2pnetworkPackage.SUBGRAPH_NODE_TEMPLATE__IS_SUBGRAPH_PROXY, oldIsSubgraphProxy, isSubgraphProxy));
	}
