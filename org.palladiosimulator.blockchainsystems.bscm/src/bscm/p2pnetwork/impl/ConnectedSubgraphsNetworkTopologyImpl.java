 ...
 * </p>
 * <ul>
 *   <li>{@link bscm.p2pnetwork.impl.ConnectedSubgraphsNetworkTopologyImpl#getSubgraphs <em>Subgraphs</em>}</li>
 *   <li>{@link bscm.p2pnetwork.impl.ConnectedSubgraphsNetworkTopologyImpl#getSubgraphLinks <em>Subgraph Links</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConnectedSubgraphsNetworkTopologyImpl extends ConstraintNetworkTopologyImpl implements ConnectedSubgraphsNetworkTopology {
	/**
	...
	public EList<SubgraphSpecification> getSubgraphs() {
		if (subgraphs == null) {
			subgraphs = new EObjectContainmentEList<SubgraphSpecification>(SubgraphSpecification.class, this, P2pnetworkPackage.CONNECTED_SUBGRAPHS_NETWORK_TOPOLOGY__SUBGRAPHS);
		}
		return subgraphs;
	}
	...
	public EList<SubgraphLink> getSubgraphLinks() {
		if (subgraphLinks == null) {
			subgraphLinks = new EObjectContainmentEList<SubgraphLink>(SubgraphLink.class, this, P2pnetworkPackage.CONNECTED_SUBGRAPHS_NETWORK_TOPOLOGY__SUBGRAPH_LINKS);
		}
