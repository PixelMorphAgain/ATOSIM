 ...
 * </p>
 * <ul>
 *   <li>{@link bscm.p2pnetwork.impl.NodeImpl#getAllocation <em>Allocation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NodeImpl extends EntityImpl implements Node {
		...
		if (allocation != null && allocation.eIsProxy()) {
			...
			if (allocation != oldAllocation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, P2pnetworkPackage.NODE__ALLOCATION, oldAllocation, allocation));
			}
		}
		return allocation;
	}
	...
	public void setAllocation(NodeAllocation newAllocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, P2pnetworkPackage.NODE__ALLOCATION, oldAllocation, allocation));
	}
