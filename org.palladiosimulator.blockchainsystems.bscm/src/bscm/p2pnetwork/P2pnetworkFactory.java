...
public interface P2pnetworkFactory extends EFactory {
	 ...
	 * @generated
	 */
	P2pnetworkFactory eINSTANCE = bscm.p2pnetwork.impl.P2pnetworkFactoryImpl.init();
	...
	/**
	 * Returns a new object of class '<em>Link Specification</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Link Specification</em>'.
	 * @generated
	 */
	LinkSpecification createLinkSpecification();
	...
	/**
	 * Returns a new object of class '<em>Link Latency Specification</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Link Latency Specification</em>'.
	 * @generated
	 */
	LinkLatencySpecification createLinkLatencySpecification();

	/**
	 * Returns a new object of class '<em>Link Latency Specification Value</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Link Latency Specification Value</em>'.
	 * @generated
	 */
	LinkLatencySpecificationValue createLinkLatencySpecificationValue();

	/**
	 * Returns a new object of class '<em>Link Throughput Specification</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Link Throughput Specification</em>'.
	 * @generated
	 */
	LinkThroughputSpecification createLinkThroughputSpecification();

	/**
	 * Returns a new object of class '<em>Link Throughput Specification Value</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Link Throughput Specification Value</em>'.
	 * @generated
	 */
	LinkThroughputSpecificationValue createLinkThroughputSpecificationValue();
