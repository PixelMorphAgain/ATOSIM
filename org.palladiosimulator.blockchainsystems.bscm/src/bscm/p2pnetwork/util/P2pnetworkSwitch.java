 ...
 * <!-- end-user-doc -->
 * @see bscm.p2pnetwork.P2pnetworkPackage
 * @generated
 */
public class P2pnetworkSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case P2pnetworkPackage.P2P_NETWORK: {
				...
				if (result == null) result = caseEntity(p2PNetwork);
				if (result == null) result = caseIdentifier(p2PNetwork);
				if (result == null) result = caseNamedElement(p2PNetwork);
				if (result == null) result = casePCMBaseClass(p2PNetwork);
				if (result == null) result = casePCMClass(p2PNetwork);
			...
			case P2pnetworkPackage.NETWORK_TOPOLOGY: {
				...
				if (result == null) result = caseEntity(networkTopology);
				if (result == null) result = caseIdentifier(networkTopology);
				if (result == null) result = caseNamedElement(networkTopology);
				if (result == null) result = casePCMBaseClass(networkTopology);
				if (result == null) result = casePCMClass(networkTopology);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case P2pnetworkPackage.EXPLICIT_NETWORK_TOPOLOGY: {
				...
				if (result == null) result = caseNetworkTopology(explicitNetworkTopology);
				if (result == null) result = caseEntity(explicitNetworkTopology);
				if (result == null) result = caseIdentifier(explicitNetworkTopology);
				if (result == null) result = caseNamedElement(explicitNetworkTopology);
				if (result == null) result = casePCMBaseClass(explicitNetworkTopology);
				if (result == null) result = casePCMClass(explicitNetworkTopology);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case P2pnetworkPackage.CONSTRAINT_NETWORK_TOPOLOGY: {
				...
				if (result == null) result = caseNetworkTopology(constraintNetworkTopology);
				if (result == null) result = caseEntity(constraintNetworkTopology);
				if (result == null) result = caseIdentifier(constraintNetworkTopology);
				if (result == null) result = caseNamedElement(constraintNetworkTopology);
				if (result == null) result = casePCMBaseClass(constraintNetworkTopology);
				if (result == null) result = casePCMClass(constraintNetworkTopology);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case P2pnetworkPackage.NODE: {
				...
				if (result == null) result = casePCMBaseClass(node);
				if (result == null) result = casePCMClass(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case P2pnetworkPackage.LINK: {
				...
				if (result == null) result = caseIdentifier(link);
				if (result == null) result = caseNamedElement(link);
				if (result == null) result = casePCMBaseClass(link);
				if (result == null) result = casePCMClass(link);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case P2pnetworkPackage.LINK_SPECIFICATION: {
				LinkSpecification linkSpecification = (LinkSpecification)theEObject;
				T result = caseLinkSpecification(linkSpecification);
				if (result == null) result = caseEntity(linkSpecification);
				if (result == null) result = caseIdentifier(linkSpecification);
				if (result == null) result = caseNamedElement(linkSpecification);
				if (result == null) result = casePCMBaseClass(linkSpecification);
				if (result == null) result = casePCMClass(linkSpecification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case P2pnetworkPackage.CONNECTED_SUBGRAPHS_NETWORK_TOPOLOGY: {
				...
				if (result == null) result = caseConstraintNetworkTopology(connectedSubgraphsNetworkTopology);
				if (result == null) result = caseNetworkTopology(connectedSubgraphsNetworkTopology);
				if (result == null) result = caseEntity(connectedSubgraphsNetworkTopology);
				if (result == null) result = caseIdentifier(connectedSubgraphsNetworkTopology);
				if (result == null) result = caseNamedElement(connectedSubgraphsNetworkTopology);
				if (result == null) result = casePCMBaseClass(connectedSubgraphsNetworkTopology);
				if (result == null) result = casePCMClass(connectedSubgraphsNetworkTopology);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case P2pnetworkPackage.SUBGRAPH_SPECIFICATION: {
				...
				if (result == null) result = caseEntity(subgraphSpecification);
				if (result == null) result = caseIdentifier(subgraphSpecification);
				if (result == null) result = caseNamedElement(subgraphSpecification);
				if (result == null) result = casePCMBaseClass(subgraphSpecification);
				if (result == null) result = casePCMClass(subgraphSpecification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case P2pnetworkPackage.SUBGRAPH_LINK: {
				...
				if (result == null) result = caseEntity(subgraphLink);
				if (result == null) result = caseIdentifier(subgraphLink);
				if (result == null) result = caseNamedElement(subgraphLink);
				if (result == null) result = casePCMBaseClass(subgraphLink);
				if (result == null) result = casePCMClass(subgraphLink);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case P2pnetworkPackage.SUBGRAPH_NODE_TEMPLATE: {
				...
				if (result == null) result = caseEntity(subgraphNodeTemplate);
				if (result == null) result = caseIdentifier(subgraphNodeTemplate);
				if (result == null) result = caseNamedElement(subgraphNodeTemplate);
				if (result == null) result = casePCMBaseClass(subgraphNodeTemplate);
				if (result == null) result = casePCMClass(subgraphNodeTemplate);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case P2pnetworkPackage.LINK_LATENCY_SPECIFICATION: {
			...
			case P2pnetworkPackage.LINK_LATENCY_SPECIFICATION_VALUE: {
				LinkLatencySpecificationValue linkLatencySpecificationValue = (LinkLatencySpecificationValue)theEObject;
				T result = caseLinkLatencySpecificationValue(linkLatencySpecificationValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case P2pnetworkPackage.LINK_THROUGHPUT_SPECIFICATION: {
			...
			case P2pnetworkPackage.LINK_THROUGHPUT_SPECIFICATION_VALUE: {
				LinkThroughputSpecificationValue linkThroughputSpecificationValue = (LinkThroughputSpecificationValue)theEObject;
				T result = caseLinkThroughputSpecificationValue(linkThroughputSpecificationValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Link Specification</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Link Specification</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLinkSpecification(LinkSpecification object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Link Latency Specification Value</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Link Latency Specification Value</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLinkLatencySpecificationValue(LinkLatencySpecificationValue object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Link Throughput Specification Value</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Link Throughput Specification Value</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLinkThroughputSpecificationValue(LinkThroughputSpecificationValue object) {
		return null;
	}
