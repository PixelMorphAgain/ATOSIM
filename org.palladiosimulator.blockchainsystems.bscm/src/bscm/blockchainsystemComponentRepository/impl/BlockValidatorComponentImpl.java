 ...
 * </p>
 * <ul>
 *   <li>{@link bscm.blockchainsystemComponentRepository.impl.BlockValidatorComponentImpl#getValidationDuration <em>Validation Duration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BlockValidatorComponentImpl extends BlockchainSystemNodeComponentImpl implements BlockValidatorComponent {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetValidationDuration(BlockValiationDurationSpecification newValidationDuration, NotificationChain msgs) {
		BlockValiationDurationSpecification oldValidationDuration = validationDuration;
		validationDuration = newValidationDuration;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BlockchainsystemComponentRepositoryPackage.BLOCK_VALIDATOR_COMPONENT__VALIDATION_DURATION, oldValidationDuration, newValidationDuration);
	...
	public void setValidationDuration(BlockValiationDurationSpecification newValidationDuration) {
		if (newValidationDuration != validationDuration) {
			...
			if (validationDuration != null)
				msgs = ((InternalEObject)validationDuration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BlockchainsystemComponentRepositoryPackage.BLOCK_VALIDATOR_COMPONENT__VALIDATION_DURATION, null, msgs);
			if (newValidationDuration != null)
				msgs = ((InternalEObject)newValidationDuration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BlockchainsystemComponentRepositoryPackage.BLOCK_VALIDATOR_COMPONENT__VALIDATION_DURATION, null, msgs);
			msgs = basicSetValidationDuration(newValidationDuration, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BlockchainsystemComponentRepositoryPackage.BLOCK_VALIDATOR_COMPONENT__VALIDATION_DURATION, newValidationDuration, newValidationDuration));
	}
