 ...
 * @generated
 */
public class BlockchainsystemComponentRepositoryFactoryImpl extends EFactoryImpl implements BlockchainsystemComponentRepositoryFactory {
	/**
	...
	public static BlockchainsystemComponentRepositoryFactory init() {
		try {
			BlockchainsystemComponentRepositoryFactory theBlockchainsystemComponentRepositoryFactory = (BlockchainsystemComponentRepositoryFactory)EPackage.Registry.INSTANCE.getEFactory(BlockchainsystemComponentRepositoryPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case BlockchainsystemComponentRepositoryPackage.BLOCKCHAIN_SYSTEM_NODE_COMPONENT_REPOSITORY: return createBlockchainSystemNodeComponentRepository();
			case BlockchainsystemComponentRepositoryPackage.BLOCK_VALIDATOR_COMPONENT: return createBlockValidatorComponent();
			case BlockchainsystemComponentRepositoryPackage.MINING_PROCESS_COMPONENT: return createMiningProcessComponent();
			case BlockchainsystemComponentRepositoryPackage.BLOCK_VALIATION_DURATION_SPECIFICATION: return createBlockValiationDurationSpecification();
			case BlockchainsystemComponentRepositoryPackage.BLOCK_VALIDATION_DURATION_VALUE: return createBlockValidationDurationValue();
			default:
