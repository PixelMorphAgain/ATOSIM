 ...
 * </p>
 * <ul>
 *   <li>{@link bscm.blockchainsystemComponentRepository.impl.MiningProcessComponentImpl#isIsMiningProcessEnabled <em>Is Mining Process Enabled</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MiningProcessComponentImpl extends BlockchainSystemNodeComponentImpl implements MiningProcessComponent {
	...
	public void setIsMiningProcessEnabled(boolean newIsMiningProcessEnabled) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BlockchainsystemComponentRepositoryPackage.MINING_PROCESS_COMPONENT__IS_MINING_PROCESS_ENABLED, oldIsMiningProcessEnabled, isMiningProcessEnabled));
	}
