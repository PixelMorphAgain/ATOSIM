 ...
 * @generated
 */
public class BlockchainsystemComponentRepositoryPackageImpl extends EPackageImpl implements BlockchainsystemComponentRepositoryPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see bscm.blockchainsystemComponentRepository.BlockchainsystemComponentRepositoryPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static BlockchainsystemComponentRepositoryPackage init() {
		if (isInited) return (BlockchainsystemComponentRepositoryPackage)EPackage.Registry.INSTANCE.getEPackage(BlockchainsystemComponentRepositoryPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredBlockchainsystemComponentRepositoryPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		BlockchainsystemComponentRepositoryPackageImpl theBlockchainsystemComponentRepositoryPackage = registeredBlockchainsystemComponentRepositoryPackage instanceof BlockchainsystemComponentRepositoryPackageImpl ? (BlockchainsystemComponentRepositoryPackageImpl)registeredBlockchainsystemComponentRepositoryPackage : new BlockchainsystemComponentRepositoryPackageImpl();
		...
		EPackage.Registry.INSTANCE.put(BlockchainsystemComponentRepositoryPackage.eNS_URI, theBlockchainsystemComponentRepositoryPackage);
	 ...
	 */
	@Override
	public EAttribute getBlockValidationDurationValue_Probabilit() {
	...
	public void createPackageContents() {
		...
		createEReference(blockchainSystemNodeComponentRepositoryEClass, BLOCKCHAIN_SYSTEM_NODE_COMPONENT_REPOSITORY__COMPONENTS);
		...
		createEAttribute(blockValidationDurationValueEClass, BLOCK_VALIDATION_DURATION_VALUE__PROBABILIT);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(blockchainSystemNodeComponentEClass, BlockchainSystemNodeComponent.class, "BlockchainSystemNodeComponent", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(blockchainSystemNodeComponentRepositoryEClass, BlockchainSystemNodeComponentRepository.class, "BlockchainSystemNodeComponentRepository", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBlockchainSystemNodeComponentRepository_Components(), this.getBlockchainSystemNodeComponent(), null, "Components", null, 0, -1, BlockchainSystemNodeComponentRepository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(blockValidatorComponentEClass, BlockValidatorComponent.class, "BlockValidatorComponent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBlockValidatorComponent_ValidationDuration(), this.getBlockValiationDurationSpecification(), null, "ValidationDuration", null, 1, 1, BlockValidatorComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(miningProcessComponentEClass, MiningProcessComponent.class, "MiningProcessComponent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMiningProcessComponent_IsMiningProcessEnabled(), theEcorePackage.getEBoolean(), "IsMiningProcessEnabled", null, 1, 1, MiningProcessComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(blockValiationDurationSpecificationEClass, BlockValiationDurationSpecification.class, "BlockValiationDurationSpecification", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBlockValiationDurationSpecification_Values(), this.getBlockValidationDurationValue(), null, "Values", null, 1, -1, BlockValiationDurationSpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(blockValidationDurationValueEClass, BlockValidationDurationValue.class, "BlockValidationDurationValue", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBlockValidationDurationValue_Duration(), theEcorePackage.getELong(), "Duration", null, 1, 1, BlockValidationDurationValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBlockValidationDurationValue_Probabilit(), theEcorePackage.getEDouble(), "Probabilit", null, 1, 1, BlockValidationDurationValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
