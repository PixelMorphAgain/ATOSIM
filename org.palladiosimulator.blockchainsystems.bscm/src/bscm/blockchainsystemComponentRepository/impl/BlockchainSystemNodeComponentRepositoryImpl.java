 ...
 * </p>
 * <ul>
 *   <li>{@link bscm.blockchainsystemComponentRepository.impl.BlockchainSystemNodeComponentRepositoryImpl#getComponents <em>Components</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BlockchainSystemNodeComponentRepositoryImpl extends EntityImpl implements BlockchainSystemNodeComponentRepository {
	/**
	...
	public EList<BlockchainSystemNodeComponent> getComponents() {
		if (components == null) {
			components = new EObjectContainmentEList<BlockchainSystemNodeComponent>(BlockchainSystemNodeComponent.class, this, BlockchainsystemComponentRepositoryPackage.BLOCKCHAIN_SYSTEM_NODE_COMPONENT_REPOSITORY__COMPONENTS);
		}
		return components;
	}
