/**
 */
package bscm.blockchainsystemComponentRepository.util;

import bscm.blockchainsystemComponentRepository.*;
 ...
 * <!-- end-user-doc -->
 * @see bscm.blockchainsystemComponentRepository.BlockchainsystemComponentRepositoryPackage
 * @generated
 */
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BlockchainsystemComponentRepositoryPackage.BLOCKCHAIN_SYSTEM_NODE_COMPONENT: {
				...
				if (result == null) result = caseEntity(blockchainSystemNodeComponent);
				if (result == null) result = caseIdentifier(blockchainSystemNodeComponent);
				if (result == null) result = caseNamedElement(blockchainSystemNodeComponent);
				if (result == null) result = casePCMBaseClass(blockchainSystemNodeComponent);
				if (result == null) result = casePCMClass(blockchainSystemNodeComponent);
			...
			case BlockchainsystemComponentRepositoryPackage.BLOCKCHAIN_SYSTEM_NODE_COMPONENT_REPOSITORY: {
				...
				if (result == null) result = caseEntity(blockchainSystemNodeComponentRepository);
				if (result == null) result = caseIdentifier(blockchainSystemNodeComponentRepository);
				if (result == null) result = caseNamedElement(blockchainSystemNodeComponentRepository);
				if (result == null) result = casePCMBaseClass(blockchainSystemNodeComponentRepository);
				if (result == null) result = casePCMClass(blockchainSystemNodeComponentRepository);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BlockchainsystemComponentRepositoryPackage.BLOCK_VALIDATOR_COMPONENT: {
				...
				if (result == null) result = caseBlockchainSystemNodeComponent(blockValidatorComponent);
				if (result == null) result = caseEntity(blockValidatorComponent);
				if (result == null) result = caseIdentifier(blockValidatorComponent);
				if (result == null) result = caseNamedElement(blockValidatorComponent);
				if (result == null) result = casePCMBaseClass(blockValidatorComponent);
				if (result == null) result = casePCMClass(blockValidatorComponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BlockchainsystemComponentRepositoryPackage.MINING_PROCESS_COMPONENT: {
				...
				if (result == null) result = caseBlockchainSystemNodeComponent(miningProcessComponent);
				if (result == null) result = caseEntity(miningProcessComponent);
				if (result == null) result = caseIdentifier(miningProcessComponent);
				if (result == null) result = caseNamedElement(miningProcessComponent);
				if (result == null) result = casePCMBaseClass(miningProcessComponent);
				if (result == null) result = casePCMClass(miningProcessComponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
