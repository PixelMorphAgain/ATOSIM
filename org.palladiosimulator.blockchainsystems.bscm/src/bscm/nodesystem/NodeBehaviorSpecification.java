 ...
 * </p>
 * <ul>
 *   <li>{@link bscm.nodesystem.NodeBehaviorSpecification#getBehavior <em>Behavior</em>}</li>
 * </ul>
 *
 * @see bscm.nodesystem.NodesystemPackage#getNodeBehaviorSpecification()
 * @model
 * @generated
 */
public interface NodeBehaviorSpecification extends Entity {
	 ...
	 * The literals are from the enumeration {@link bscm.nodesystem.NodeBehavior}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Behavior</em>' attribute.
	 * @see bscm.nodesystem.NodeBehavior
	 * @see #setBehavior(NodeBehavior)
	 * @see bscm.nodesystem.NodesystemPackage#getNodeBehaviorSpecification_Behavior()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link bscm.nodesystem.NodeBehaviorSpecification#getBehavior <em>Behavior</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
