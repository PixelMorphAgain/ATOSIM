...
public class NodesystemFactoryImpl extends EFactoryImpl implements NodesystemFactory {
	...
	public static NodesystemFactory init() {
		try {
			NodesystemFactory theNodesystemFactory = (NodesystemFactory)EPackage.Registry.INSTANCE.getEFactory(NodesystemPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case NodesystemPackage.BLOCKCHAIN_SYSTEM_NODE_SYSTEM: return createBlockchainSystemNodeSystem();
			case NodesystemPackage.BLOCKCHAIN_SYSTEM_NODE_ASSEMBLY_CONTEXT: return createBlockchainSystemNodeAssemblyContext();
			case NodesystemPackage.NODE_BEHAVIOR_SPECIFICATION: return createNodeBehaviorSpecification();
			default:
