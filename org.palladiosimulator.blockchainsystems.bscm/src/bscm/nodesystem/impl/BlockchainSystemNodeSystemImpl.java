 ...
 * </p>
 * <ul>
 *   <li>{@link bscm.nodesystem.impl.BlockchainSystemNodeSystemImpl#getMiningProcessAssembly <em>Mining Process Assembly</em>}</li>
 *   <li>{@link bscm.nodesystem.impl.BlockchainSystemNodeSystemImpl#getBlockValidatorAssembly <em>Block Validator Assembly</em>}</li>
 *   <li>{@link bscm.nodesystem.impl.BlockchainSystemNodeSystemImpl#getAssemblyContexts <em>Assembly Contexts</em>}</li>
 *   <li>{@link bscm.nodesystem.impl.BlockchainSystemNodeSystemImpl#getBehavior <em>Behavior</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BlockchainSystemNodeSystemImpl extends EntityImpl implements BlockchainSystemNodeSystem {
		...
		if (miningProcessAssembly != null && miningProcessAssembly.eIsProxy()) {
			...
			if (miningProcessAssembly != oldMiningProcessAssembly) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, NodesystemPackage.BLOCKCHAIN_SYSTEM_NODE_SYSTEM__MINING_PROCESS_ASSEMBLY, oldMiningProcessAssembly, miningProcessAssembly));
			}
		}
	...
	public void setMiningProcessAssembly(BlockchainSystemNodeAssemblyContext newMiningProcessAssembly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NodesystemPackage.BLOCKCHAIN_SYSTEM_NODE_SYSTEM__MINING_PROCESS_ASSEMBLY, oldMiningProcessAssembly, miningProcessAssembly));
	}
	...
	public BlockchainSystemNodeAssemblyContext getBlockValidatorAssembly() {
		if (blockValidatorAssembly != null && blockValidatorAssembly.eIsProxy()) {
			...
			if (blockValidatorAssembly != oldBlockValidatorAssembly) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, NodesystemPackage.BLOCKCHAIN_SYSTEM_NODE_SYSTEM__BLOCK_VALIDATOR_ASSEMBLY, oldBlockValidatorAssembly, blockValidatorAssembly));
			}
		}
	...
	public void setBlockValidatorAssembly(BlockchainSystemNodeAssemblyContext newBlockValidatorAssembly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NodesystemPackage.BLOCKCHAIN_SYSTEM_NODE_SYSTEM__BLOCK_VALIDATOR_ASSEMBLY, oldBlockValidatorAssembly, blockValidatorAssembly));
	}
	...
	public EList<BlockchainSystemNodeAssemblyContext> getAssemblyContexts() {
		if (assemblyContexts == null) {
			assemblyContexts = new EObjectContainmentEList<BlockchainSystemNodeAssemblyContext>(BlockchainSystemNodeAssemblyContext.class, this, NodesystemPackage.BLOCKCHAIN_SYSTEM_NODE_SYSTEM__ASSEMBLY_CONTEXTS);
		}
	...
	public NotificationChain basicSetBehavior(NodeBehaviorSpecification newBehavior, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, NodesystemPackage.BLOCKCHAIN_SYSTEM_NODE_SYSTEM__BEHAVIOR, oldBehavior, newBehavior);
	...
	public void setBehavior(NodeBehaviorSpecification newBehavior) {
		if (newBehavior != behavior) {
			...
			if (behavior != null)
				msgs = ((InternalEObject)behavior).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - NodesystemPackage.BLOCKCHAIN_SYSTEM_NODE_SYSTEM__BEHAVIOR, null, msgs);
			if (newBehavior != null)
				msgs = ((InternalEObject)newBehavior).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - NodesystemPackage.BLOCKCHAIN_SYSTEM_NODE_SYSTEM__BEHAVIOR, null, msgs);
			msgs = basicSetBehavior(newBehavior, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NodesystemPackage.BLOCKCHAIN_SYSTEM_NODE_SYSTEM__BEHAVIOR, newBehavior, newBehavior));
	}
