...
import bscm.nodesystem.NodeBehavior;
...
public class NodesystemPackageImpl extends EPackageImpl implements NodesystemPackage {
	 ...
	 * @see bscm.nodesystem.NodesystemPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static NodesystemPackage init() {
		if (isInited) return (NodesystemPackage)EPackage.Registry.INSTANCE.getEPackage(NodesystemPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredNodesystemPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		NodesystemPackageImpl theNodesystemPackage = registeredNodesystemPackage instanceof NodesystemPackageImpl ? (NodesystemPackageImpl)registeredNodesystemPackage : new NodesystemPackageImpl();
	...
	public void createPackageContents() {
		...
		createEReference(blockchainSystemNodeAssemblyContextEClass, BLOCKCHAIN_SYSTEM_NODE_ASSEMBLY_CONTEXT__ENCAPSULATED_COMPONENT);
	...
	public void initializePackageContents() {
		...
		BlockchainsystemComponentRepositoryPackage theBlockchainsystemComponentRepositoryPackage = (BlockchainsystemComponentRepositoryPackage)EPackage.Registry.INSTANCE.getEPackage(BlockchainsystemComponentRepositoryPackage.eNS_URI);
		...
		initEClass(blockchainSystemNodeSystemEClass, BlockchainSystemNodeSystem.class, "BlockchainSystemNodeSystem", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBlockchainSystemNodeSystem_MiningProcessAssembly(), this.getBlockchainSystemNodeAssemblyContext(), null, "MiningProcessAssembly", null, 1, 1, BlockchainSystemNodeSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBlockchainSystemNodeSystem_BlockValidatorAssembly(), this.getBlockchainSystemNodeAssemblyContext(), null, "BlockValidatorAssembly", null, 1, 1, BlockchainSystemNodeSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBlockchainSystemNodeSystem_AssemblyContexts(), this.getBlockchainSystemNodeAssemblyContext(), null, "AssemblyContexts", null, 0, -1, BlockchainSystemNodeSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBlockchainSystemNodeSystem_Behavior(), this.getNodeBehaviorSpecification(), null, "Behavior", null, 1, 1, BlockchainSystemNodeSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(blockchainSystemNodeAssemblyContextEClass, BlockchainSystemNodeAssemblyContext.class, "BlockchainSystemNodeAssemblyContext", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBlockchainSystemNodeAssemblyContext_EncapsulatedComponent(), theBlockchainsystemComponentRepositoryPackage.getBlockchainSystemNodeComponent(), null, "EncapsulatedComponent", null, 1, 1, BlockchainSystemNodeAssemblyContext.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(nodeBehaviorSpecificationEClass, NodeBehaviorSpecification.class, "NodeBehaviorSpecification", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNodeBehaviorSpecification_Behavior(), this.getNodeBehavior(), "Behavior", null, 1, 1, NodeBehaviorSpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
