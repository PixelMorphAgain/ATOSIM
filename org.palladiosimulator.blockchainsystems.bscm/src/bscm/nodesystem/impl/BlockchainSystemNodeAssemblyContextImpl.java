 ...
 * </p>
 * <ul>
 *   <li>{@link bscm.nodesystem.impl.BlockchainSystemNodeAssemblyContextImpl#getEncapsulatedComponent <em>Encapsulated Component</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BlockchainSystemNodeAssemblyContextImpl extends EntityImpl implements BlockchainSystemNodeAssemblyContext {
		...
		if (encapsulatedComponent != null && encapsulatedComponent.eIsProxy()) {
			...
			if (encapsulatedComponent != oldEncapsulatedComponent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, NodesystemPackage.BLOCKCHAIN_SYSTEM_NODE_ASSEMBLY_CONTEXT__ENCAPSULATED_COMPONENT, oldEncapsulatedComponent, encapsulatedComponent));
			}
		}
	...
	public void setEncapsulatedComponent(BlockchainSystemNodeComponent newEncapsulatedComponent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NodesystemPackage.BLOCKCHAIN_SYSTEM_NODE_ASSEMBLY_CONTEXT__ENCAPSULATED_COMPONENT, oldEncapsulatedComponent, encapsulatedComponent));
	}
