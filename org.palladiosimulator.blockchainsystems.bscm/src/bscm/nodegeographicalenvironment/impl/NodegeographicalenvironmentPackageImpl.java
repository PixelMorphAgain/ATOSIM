...
import bscm.nodegeographicalenvironment.NodegeographicalenvironmentFactory;
 ...
 * @generated
 */
public class NodegeographicalenvironmentPackageImpl extends EPackageImpl implements NodegeographicalenvironmentPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass nodeGeographicalEnvironmentEClass = null;
	 ...
	 * @generated
	 */
	private EClass nodeGeographicalRegionSpecificationEClass = null;
	 ...
	 * @see bscm.nodegeographicalenvironment.NodegeographicalenvironmentPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private NodegeographicalenvironmentPackageImpl() {
		super(eNS_URI, NodegeographicalenvironmentFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link NodegeographicalenvironmentPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static NodegeographicalenvironmentPackage init() {
		if (isInited) return (NodegeographicalenvironmentPackage)EPackage.Registry.INSTANCE.getEPackage(NodegeographicalenvironmentPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredNodegeographicalenvironmentPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		NodegeographicalenvironmentPackageImpl theNodegeographicalenvironmentPackage = registeredNodegeographicalenvironmentPackage instanceof NodegeographicalenvironmentPackageImpl ? (NodegeographicalenvironmentPackageImpl)registeredNodegeographicalenvironmentPackage : new NodegeographicalenvironmentPackageImpl();
		...
		theNodegeographicalenvironmentPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(NodegeographicalenvironmentPackage.eNS_URI, theNodegeographicalenvironmentPackage);
		return theNodegeographicalenvironmentPackage;
	}
	 ...
	 */
	@Override
	public EClass getNodeGeographicalEnvironment() {
		return nodeGeographicalEnvironmentEClass;
	}
	 ...
	 */
	@Override
	public EReference getNodeGeographicalEnvironment_NodeGeographicalRegionSpecification() {
		return (EReference)nodeGeographicalEnvironmentEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EClass getNodeGeographicalRegionSpecification() {
		return nodeGeographicalRegionSpecificationEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getNodeGeographicalRegionSpecification_Region() {
		return (EAttribute)nodeGeographicalRegionSpecificationEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public NodegeographicalenvironmentFactory getNodegeographicalenvironmentFactory() {
		return (NodegeographicalenvironmentFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		nodeGeographicalEnvironmentEClass = createEClass(NODE_GEOGRAPHICAL_ENVIRONMENT);
		createEReference(nodeGeographicalEnvironmentEClass, NODE_GEOGRAPHICAL_ENVIRONMENT__NODE_GEOGRAPHICAL_REGION_SPECIFICATION);

		nodeGeographicalRegionSpecificationEClass = createEClass(NODE_GEOGRAPHICAL_REGION_SPECIFICATION);
		createEAttribute(nodeGeographicalRegionSpecificationEClass, NODE_GEOGRAPHICAL_REGION_SPECIFICATION__REGION);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(nodeGeographicalEnvironmentEClass, NodeGeographicalEnvironment.class, "NodeGeographicalEnvironment", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getNodeGeographicalEnvironment_NodeGeographicalRegionSpecification(), this.getNodeGeographicalRegionSpecification(), null, "NodeGeographicalRegionSpecification", null, 1, 1, NodeGeographicalEnvironment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(nodeGeographicalRegionSpecificationEClass, NodeGeographicalRegionSpecification.class, "NodeGeographicalRegionSpecification", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNodeGeographicalRegionSpecification_Region(), theEcorePackage.getEString(), "Region", null, 1, 1, NodeGeographicalRegionSpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Create resource
		createResource(eNS_URI);
	}

} //NodegeographicalenvironmentPackageImpl
