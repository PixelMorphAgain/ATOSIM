...
public class ProbfunctionAdapterFactory extends AdapterFactoryImpl {
	...
	protected ProbfunctionSwitch<Adapter> modelSwitch =
		new ProbfunctionSwitch<Adapter>() {
			...
			@Override
			public <T> Adapter caseProbabilityMassFunction(ProbabilityMassFunction<T> object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link probfunction.IntSample <em>Int Sample</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link probfunction.BoolSample <em>Bool Sample</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link probfunction.DoubleSample <em>Double Sample</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link probfunction.StringSample <em>String Sample</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
