...
public class ProbabilityMassFunctionImpl<T> extends ProbabilityFunctionImpl implements ProbabilityMassFunction<T> {
	 ...
	 * @ordered
	 */
	protected EList<Sample<T>> samples;
	...
	public EList<Sample<T>> getSamples() {
		if (samples == null) {
			samples = new EObjectContainmentEList<Sample<T>>(Sample.class, this, ProbfunctionPackage.PROBABILITY_MASS_FUNCTION__SAMPLES);
		}
		return samples;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ProbfunctionPackage.PROBABILITY_MASS_FUNCTION__SAMPLES:
				getSamples().clear();
				getSamples().addAll((Collection<? extends Sample<T>>)newValue);
				return;
			case ProbfunctionPackage.PROBABILITY_MASS_FUNCTION__ORDERED_DOMAIN:
