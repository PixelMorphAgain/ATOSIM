 ...
 * </p>
 * <ul>
 *   <li>{@link stoex.NegativeExpression#getInner <em>Inner</em>}</li>
 * </ul>
 *
 * @see stoex.StoexPackage#getNegativeExpression()
 * @model
 * @generated
 */
public interface NegativeExpression extends Unary {
	 ...
	 * @see #setInner(Unary)
	 * @see stoex.StoexPackage#getNegativeExpression_Inner()
	...
	/**
	 * Sets the value of the '{@link stoex.NegativeExpression#getInner <em>Inner</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
