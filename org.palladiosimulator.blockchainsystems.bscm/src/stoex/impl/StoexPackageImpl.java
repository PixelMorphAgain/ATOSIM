...
import stoex.ProbabilityFunctionLiteral;
import stoex.Product;
import stoex.ProductExpression;
import stoex.ProductOperations;
import stoex.RandomVariable;
import stoex.StoexFactory;
import stoex.StoexPackage;
import stoex.StringLiteral;
import stoex.Term;
import stoex.TermExpression;
import stoex.TermOperations;
import stoex.Unary;
import stoex.Variable;
import stoex.VariableReference;

import stoex.util.StoexValidator;
...
public class StoexPackageImpl extends EPackageImpl implements StoexPackage {
	 ...
	 * @see stoex.StoexPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static StoexPackage init() {
		...
		Object registeredStoexPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		StoexPackageImpl theStoexPackage = registeredStoexPackage instanceof StoexPackageImpl ? (StoexPackageImpl)registeredStoexPackage : new StoexPackageImpl();
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (abstractNamedReferenceEClass,
		   source,
		   new String[] {
			   "constraints", "referenceSegmentMustNeverContainADot"
		   });
	}
	...
	protected void createOCLAnnotations() {
		...
		addAnnotation
		  (abstractNamedReferenceEClass,
		   source,
		   new String[] {
			   "referenceSegmentMustNeverContainADot", "self.referenceName.size() = 0 or not Sequence{1..self.referenceName.size()}->exists(i | self.referenceName.substring(i, i) = \'.\')"
		   });
	}
