...
public class PcmPackageImpl extends EPackageImpl implements PcmPackage {
	 ...
	 * @generated
	 */
	private EClass pcmBaseClassEClass = null;
	 ...
	 * @generated
	 */
	private EClass pcmClassEClass = null;
	...
	public void createPackageContents() {
		...
		pcmBaseClassEClass = createEClass(PCM_BASE_CLASS);

		pcmClassEClass = createEClass(PCM_CLASS);
	...
	public void initializePackageContents() {
		...
		pcmBaseClassEClass.getESuperTypes().add(this.getPCMClass());
		pcmBaseClassEClass.getESuperTypes().add(theEcorePackage.getEObject());
		dummyClassEClass.getESuperTypes().add(this.getPCMBaseClass());

		// Initialize classes, features, and operations; add parameters
		initEClass(pcmBaseClassEClass, PCMBaseClass.class, "PCMBaseClass", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(pcmClassEClass, PCMClass.class, "PCMClass", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
