 ...
 * </p>
 * <ul>
 *   <li>{@link pcm.repository.EventGroup#getEventTypes__EventGroup <em>Event Types Event Group</em>}</li>
 * </ul>
 *
 * @see pcm.repository.RepositoryPackage#getEventGroup()
 * @model
 * @generated
 */
public interface EventGroup extends Interface {
	 ...
	 * The list contents are of type {@link pcm.repository.EventType}.
	 * It is bidirectional and its opposite is '{@link pcm.repository.EventType#getEventGroup__EventType <em>Event Group Event Type</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Event Types Event Group</em>' containment reference list.
	 * @see pcm.repository.RepositoryPackage#getEventGroup_EventTypes__EventGroup()
