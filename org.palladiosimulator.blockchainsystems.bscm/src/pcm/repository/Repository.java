 ...
 * </p>
 * <ul>
 *   <li>{@link pcm.repository.Repository#getRepositoryDescription <em>Repository Description</em>}</li>
 *   <li>{@link pcm.repository.Repository#getComponents__Repository <em>Components Repository</em>}</li>
 *   <li>{@link pcm.repository.Repository#getInterfaces__Repository <em>Interfaces Repository</em>}</li>
 *   <li>{@link pcm.repository.Repository#getFailureTypes__Repository <em>Failure Types Repository</em>}</li>
 *   <li>{@link pcm.repository.Repository#getDataTypes__Repository <em>Data Types Repository</em>}</li>
 * </ul>
 *
 * @see pcm.repository.RepositoryPackage#getRepository()
 * @model annotation="http://www.eclipse.org/emf/2002/Ecore constraints='repositorynotempty'"
...
public interface Repository extends Entity {
	 ...
	 * @see pcm.repository.RepositoryPackage#getRepository_RepositoryDescription()
	...
	/**
	 * Sets the value of the '{@link pcm.repository.Repository#getRepositoryDescription <em>Repository Description</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link pcm.repository.RepositoryComponent}.
	 * It is bidirectional and its opposite is '{@link pcm.repository.RepositoryComponent#getRepository__RepositoryComponent <em>Repository Repository Component</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see pcm.repository.RepositoryPackage#getRepository_Components__Repository()
	 ...
	 * The list contents are of type {@link pcm.repository.Interface}.
	 * It is bidirectional and its opposite is '{@link pcm.repository.Interface#getRepository__Interface <em>Repository Interface</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see pcm.repository.RepositoryPackage#getRepository_Interfaces__Repository()
	 ...
	 * It is bidirectional and its opposite is '{@link pcm.reliability.FailureType#getRepository__FailureType <em>Repository Failure Type</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Failure Types Repository</em>' containment reference list.
	 * @see pcm.repository.RepositoryPackage#getRepository_FailureTypes__Repository()
	 ...
	 * The list contents are of type {@link pcm.repository.DataType}.
	 * It is bidirectional and its opposite is '{@link pcm.repository.DataType#getRepository__DataType <em>Repository Data Type</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see pcm.repository.RepositoryPackage#getRepository_DataTypes__Repository()
