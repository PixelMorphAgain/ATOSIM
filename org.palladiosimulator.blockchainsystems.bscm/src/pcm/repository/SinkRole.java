 ...
 * </p>
 * <ul>
 *   <li>{@link pcm.repository.SinkRole#getEventGroup__SinkRole <em>Event Group Sink Role</em>}</li>
 * </ul>
 *
 * @see pcm.repository.RepositoryPackage#getSinkRole()
 * @model
 * @generated
 */
public interface SinkRole extends ProvidedRole {
	 ...
	 * @see pcm.repository.RepositoryPackage#getSinkRole_EventGroup__SinkRole()
	...
	/**
	 * Sets the value of the '{@link pcm.repository.SinkRole#getEventGroup__SinkRole <em>Event Group Sink Role</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
