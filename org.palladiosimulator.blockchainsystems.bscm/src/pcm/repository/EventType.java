 ...
 * </p>
 * <ul>
 *   <li>{@link pcm.repository.EventType#getParameter__EventType <em>Parameter Event Type</em>}</li>
 *   <li>{@link pcm.repository.EventType#getEventGroup__EventType <em>Event Group Event Type</em>}</li>
 * </ul>
 *
 * @see pcm.repository.RepositoryPackage#getEventType()
 * @model
 * @generated
 */
public interface EventType extends Signature {
	 ...
	 * It is bidirectional and its opposite is '{@link pcm.repository.Parameter#getEventType__Parameter <em>Event Type Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Parameter Event Type</em>' containment reference.
	 * @see #setParameter__EventType(Parameter)
	 * @see pcm.repository.RepositoryPackage#getEventType_Parameter__EventType()
	...
	/**
	 * Sets the value of the '{@link pcm.repository.EventType#getParameter__EventType <em>Parameter Event Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link pcm.repository.EventGroup#getEventTypes__EventGroup <em>Event Types Event Group</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Event Group Event Type</em>' container reference.
	 * @see #setEventGroup__EventType(EventGroup)
	 * @see pcm.repository.RepositoryPackage#getEventType_EventGroup__EventType()
	...
	/**
	 * Sets the value of the '{@link pcm.repository.EventType#getEventGroup__EventType <em>Event Group Event Type</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
