 ...
 * </p>
 * <ul>
 *   <li>{@link pcm.repository.Interface#getParentInterfaces__Interface <em>Parent Interfaces Interface</em>}</li>
 *   <li>{@link pcm.repository.Interface#getProtocols__Interface <em>Protocols Interface</em>}</li>
 *   <li>{@link pcm.repository.Interface#getRequiredCharacterisations <em>Required Characterisations</em>}</li>
 *   <li>{@link pcm.repository.Interface#getRepository__Interface <em>Repository Interface</em>}</li>
 * </ul>
 *
 * @see pcm.repository.RepositoryPackage#getInterface()
 * @model abstract="true"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='noProtocolTypeIDUsedTwice'"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/LPG noProtocolTypeIDUsedTwice='self.protocols__Interface-&gt;forAll(p1, p2 |\r\np1.protocolTypeID &lt;&gt; p2.protocolTypeID)\r\n'"
 * @generated
 */
public interface Interface extends Entity {
	 ...
	 * @see pcm.repository.RepositoryPackage#getInterface_ParentInterfaces__Interface()
	 * @model ordered="false"
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link pcm.protocol.Protocol}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see pcm.repository.RepositoryPackage#getInterface_Protocols__Interface()
	 ...
	 * The list contents are of type {@link pcm.repository.RequiredCharacterisation}.
	 * It is bidirectional and its opposite is '{@link pcm.repository.RequiredCharacterisation#getInterface_RequiredCharacterisation <em>Interface Required Characterisation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see pcm.repository.RepositoryPackage#getInterface_RequiredCharacterisations()
	 ...
	 * It is bidirectional and its opposite is '{@link pcm.repository.Repository#getInterfaces__Repository <em>Interfaces Repository</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see pcm.repository.RepositoryPackage#getInterface_Repository__Interface()
	...
	/**
	 * Sets the value of the '{@link pcm.repository.Interface#getRepository__Interface <em>Repository Interface</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model required="true" otherInterfaceRequired="true"
	 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/LPG body='self-&gt;closure(i : Interface | i.parentInterfaces__Interface)-&gt;including(self)-&gt;includes(otherInterface)'"
	 * @generated
	 */
