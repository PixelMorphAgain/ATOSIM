 ...
 * </p>
 * <ul>
 *   <li>{@link pcm.repository.RequiredRole#getRequiringEntity_RequiredRole <em>Requiring Entity Required Role</em>}</li>
 * </ul>
 *
 * @see pcm.repository.RepositoryPackage#getRequiredRole()
 * @model abstract="true"
 * @generated
 */
public interface RequiredRole extends Role {
	 ...
	 * It is bidirectional and its opposite is '{@link pcm.core.entity.InterfaceRequiringEntity#getRequiredRoles_InterfaceRequiringEntity <em>Required Roles Interface Requiring Entity</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see pcm.repository.RepositoryPackage#getRequiredRole_RequiringEntity_RequiredRole()
	...
	/**
	 * Sets the value of the '{@link pcm.repository.RequiredRole#getRequiringEntity_RequiredRole <em>Requiring Entity Required Role</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
