	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case QosannotationsPackage.SPECIFIED_QO_SANNOTATION: {
				...
				if (result == null) result = casePCMBaseClass(specifiedQoSAnnotation);
				if (result == null) result = casePCMClass(specifiedQoSAnnotation);
			...
			case QosannotationsPackage.QO_SANNOTATIONS: {
				...
				if (result == null) result = casePCMBaseClass(qoSAnnotations);
				if (result == null) result = casePCMClass(qoSAnnotations);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
