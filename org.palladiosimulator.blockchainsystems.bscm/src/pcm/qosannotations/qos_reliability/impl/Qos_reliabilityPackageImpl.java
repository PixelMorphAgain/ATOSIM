...
import pcm.qosannotations.qos_reliability.util.Qos_reliabilityValidator;
...
public class Qos_reliabilityPackageImpl extends EPackageImpl implements Qos_reliabilityPackage {
	 ...
	 * @see pcm.qosannotations.qos_reliability.Qos_reliabilityPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static Qos_reliabilityPackage init() {
		...
		Object registeredQos_reliabilityPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		Qos_reliabilityPackageImpl theQos_reliabilityPackage = registeredQos_reliabilityPackage instanceof Qos_reliabilityPackageImpl ? (Qos_reliabilityPackageImpl)registeredQos_reliabilityPackage : new Qos_reliabilityPackageImpl();
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (specifiedReliabilityAnnotationEClass,
		   source,
		   new String[] {
			   "constraints", "specifiedReliabilityAnnotationMustReferenceRequiredRoleOfASystem multipleExternalOccurrenceDescriptionsPerFailureTypeNotAllowed sumOfReliabilityAnnotationFailureProbabilitiesMustNotExceed1"
		   });
	}
	...
	protected void createLPGAnnotations() {
		...
		addAnnotation
		  (specifiedReliabilityAnnotationEClass,
		   source,
		   new String[] {
			   "specifiedReliabilityAnnotationMustReferenceRequiredRoleOfASystem", "(self.role_SpecifiedQoSAnnotation.oclIsTypeOf(pcm::repository::OperationRequiredRole)) and (self.role_SpecifiedQoSAnnotation.oclAsType(pcm::repository::OperationRequiredRole).requiringEntity_RequiredRole.oclIsTypeOf(pcm::system::System))\r\n\r\n\r\n",
			   "sumOfReliabilityAnnotationFailureProbabilitiesMustNotExceed1", "self.externalFailureOccurrenceDescriptions__SpecifiedReliabilityAnnotation.failureProbability.oclAsType(Real)->sum()<=1.0",
