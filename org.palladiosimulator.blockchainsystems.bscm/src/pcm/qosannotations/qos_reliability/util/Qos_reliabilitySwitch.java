 ...
 * @generated
 */
public class Qos_reliabilitySwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Qos_reliabilityPackage.SPECIFIED_RELIABILITY_ANNOTATION: {
				...
				if (result == null) result = casePCMBaseClass(specifiedReliabilityAnnotation);
				if (result == null) result = casePCMClass(specifiedReliabilityAnnotation);
