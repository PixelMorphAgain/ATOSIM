 ...
 * </p>
 * <ul>
 *   <li>{@link pcm.qosannotations.impl.QoSAnnotationsImpl#getSpecifiedOutputParameterAbstractions_QoSAnnotations <em>Specified Output Parameter Abstractions Qo SAnnotations</em>}</li>
 *   <li>{@link pcm.qosannotations.impl.QoSAnnotationsImpl#getSystem_QoSAnnotations <em>System Qo SAnnotations</em>}</li>
 *   <li>{@link pcm.qosannotations.impl.QoSAnnotationsImpl#getSpecifiedQoSAnnotations_QoSAnnotations <em>Specified Qo SAnnotations Qo SAnnotations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QoSAnnotationsImpl extends EntityImpl implements QoSAnnotations {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSystem_QoSAnnotations(pcm.system.System newSystem_QoSAnnotations, NotificationChain msgs) {
	 ...
	 */
	@Override
	public void setSystem_QoSAnnotations(pcm.system.System newSystem_QoSAnnotations) {
		if (newSystem_QoSAnnotations != eInternalContainer() || (eContainerFeatureID() != QosannotationsPackage.QO_SANNOTATIONS__SYSTEM_QO_SANNOTATIONS && newSystem_QoSAnnotations != null)) {
			...
			if (newSystem_QoSAnnotations != null)
				msgs = ((InternalEObject)newSystem_QoSAnnotations).eInverseAdd(this, SystemPackage.SYSTEM__QOS_ANNOTATIONS_SYSTEM, pcm.system.System.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case QosannotationsPackage.QO_SANNOTATIONS__SYSTEM_QO_SANNOTATIONS:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetSystem_QoSAnnotations((pcm.system.System)otherEnd, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case QosannotationsPackage.QO_SANNOTATIONS__SYSTEM_QO_SANNOTATIONS:
				return eInternalContainer().eInverseRemove(this, SystemPackage.SYSTEM__QOS_ANNOTATIONS_SYSTEM, pcm.system.System.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case QosannotationsPackage.QO_SANNOTATIONS__SPECIFIED_OUTPUT_PARAMETER_ABSTRACTIONS_QO_SANNOTATIONS:
				...
				return;
			case QosannotationsPackage.QO_SANNOTATIONS__SYSTEM_QO_SANNOTATIONS:
				setSystem_QoSAnnotations((pcm.system.System)newValue);
				return;
			case QosannotationsPackage.QO_SANNOTATIONS__SPECIFIED_QO_SANNOTATIONS_QO_SANNOTATIONS:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case QosannotationsPackage.QO_SANNOTATIONS__SPECIFIED_OUTPUT_PARAMETER_ABSTRACTIONS_QO_SANNOTATIONS:
				...
				return;
			case QosannotationsPackage.QO_SANNOTATIONS__SYSTEM_QO_SANNOTATIONS:
				setSystem_QoSAnnotations((pcm.system.System)null);
				return;
			case QosannotationsPackage.QO_SANNOTATIONS__SPECIFIED_QO_SANNOTATIONS_QO_SANNOTATIONS:
				getSpecifiedQoSAnnotations_QoSAnnotations().clear();
				return;
