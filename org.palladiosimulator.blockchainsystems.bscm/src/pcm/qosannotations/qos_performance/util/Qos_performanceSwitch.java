 ...
 * @generated
 */
public class Qos_performanceSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Qos_performancePackage.SYSTEM_SPECIFIED_EXECUTION_TIME: {
				...
				if (result == null) result = casePCMBaseClass(systemSpecifiedExecutionTime);
				if (result == null) result = casePCMClass(systemSpecifiedExecutionTime);
			...
			case Qos_performancePackage.SPECIFIED_EXECUTION_TIME: {
				...
				if (result == null) result = casePCMBaseClass(specifiedExecutionTime);
				if (result == null) result = casePCMClass(specifiedExecutionTime);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Qos_performancePackage.COMPONENT_SPECIFIED_EXECUTION_TIME: {
				...
				if (result == null) result = casePCMBaseClass(componentSpecifiedExecutionTime);
				if (result == null) result = casePCMClass(componentSpecifiedExecutionTime);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
