 ...
 * </p>
 * <ul>
 *   <li>{@link pcm.resourceenvironment.impl.ResourceContainerImpl#getActiveResourceSpecifications_ResourceContainer <em>Active Resource Specifications Resource Container</em>}</li>
 *   <li>{@link pcm.resourceenvironment.impl.ResourceContainerImpl#getResourceEnvironment_ResourceContainer <em>Resource Environment Resource Container</em>}</li>
 *   <li>{@link pcm.resourceenvironment.impl.ResourceContainerImpl#getNestedResourceContainers__ResourceContainer <em>Nested Resource Containers Resource Container</em>}</li>
 *   <li>{@link pcm.resourceenvironment.impl.ResourceContainerImpl#getParentResourceContainer__ResourceContainer <em>Parent Resource Container Resource Container</em>}</li>
 *   <li>{@link pcm.resourceenvironment.impl.ResourceContainerImpl#getHddResourceSpecifications <em>Hdd Resource Specifications</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceContainerImpl extends EntityImpl implements ResourceContainer {
	...
	public EList<HDDProcessingResourceSpecification> getHddResourceSpecifications() {
		if (hddResourceSpecifications == null) {
			hddResourceSpecifications = new EObjectWithInverseResolvingEList<HDDProcessingResourceSpecification>(HDDProcessingResourceSpecification.class, this, ResourceenvironmentPackage.RESOURCE_CONTAINER__HDD_RESOURCE_SPECIFICATIONS, ResourceenvironmentPackage.HDD_PROCESSING_RESOURCE_SPECIFICATION__RESOURCE_CONTAINER);
		}
