 ...
 * </p>
 * <ul>
 *   <li>{@link pcm.protocol.Protocol#getProtocolTypeID <em>Protocol Type ID</em>}</li>
 * </ul>
 *
 * @see pcm.protocol.ProtocolPackage#getProtocol()
 * @model abstract="true"
 * @generated
 */
public interface Protocol extends EObject {
	 ...
	 * @see pcm.protocol.ProtocolPackage#getProtocol_ProtocolTypeID()
	...
	/**
	 * Sets the value of the '{@link pcm.protocol.Protocol#getProtocolTypeID <em>Protocol Type ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
