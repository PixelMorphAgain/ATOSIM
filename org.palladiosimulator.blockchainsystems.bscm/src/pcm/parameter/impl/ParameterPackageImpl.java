...
public class ParameterPackageImpl extends EPackageImpl implements ParameterPackage {
	 ...
	 * @see pcm.parameter.ParameterPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		variableUsageEClass.getESuperTypes().add(thePcmPackage.getPCMBaseClass());
		variableCharacterisationEClass.getESuperTypes().add(thePcmPackage.getPCMBaseClass());
		characterisedVariableEClass.getESuperTypes().add(theStoexPackage.getVariable());
		characterisedVariableEClass.getESuperTypes().add(thePcmPackage.getPCMBaseClass());
