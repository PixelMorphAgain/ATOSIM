	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ParameterPackage.VARIABLE_USAGE: {
				...
				if (result == null) result = casePCMBaseClass(variableUsage);
				if (result == null) result = casePCMClass(variableUsage);
			...
			case ParameterPackage.VARIABLE_CHARACTERISATION: {
				...
				if (result == null) result = casePCMBaseClass(variableCharacterisation);
				if (result == null) result = casePCMClass(variableCharacterisation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParameterPackage.CHARACTERISED_VARIABLE: {
				...
				if (result == null) result = casePCMBaseClass(characterisedVariable);
				if (result == null) result = caseAtom(characterisedVariable);
				if (result == null) result = casePCMClass(characterisedVariable);
