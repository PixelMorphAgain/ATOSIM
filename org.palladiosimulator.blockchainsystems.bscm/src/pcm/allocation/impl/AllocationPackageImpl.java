...
public class AllocationPackageImpl extends EPackageImpl implements AllocationPackage {
	 ...
	 * @see pcm.allocation.AllocationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EOperation getAllocation__ValidateEachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnce__DiagnosticChain_Map() {
		return allocationEClass.getEOperations().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEOperation(allocationEClass, ALLOCATION___VALIDATE_EACH_ASSEMBLY_CONTEXT_WITHIN_SYSTEM_HAS_TO_BE_ALLOCATED_EXACTLY_ONCE__DIAGNOSTICCHAIN_MAP);
	}
	...
	public void initializePackageContents() {
		...
		EOperation op = initEOperation(getAllocation__ValidateEachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnce__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "validateEachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnce", 1, 1, IS_UNIQUE, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (allocationContextEClass,
		   source,
		   new String[] {
			   "constraints", "oneAssemblyContextOrOneEventChannelShouldBeReferred"
		   });
		addAnnotation
		  (allocationEClass,
		   source,
		   new String[] {
			   "constraints", "communicatingServersHaveToBeConnectedByLinkingResource"
		   });
		addAnnotation
		  (getAllocation__ValidateEachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnce__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "invariant", "true"
		   });
