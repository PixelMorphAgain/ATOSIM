...
import pcm.allocation.AllocationContext;
import pcm.allocation.AllocationPackage;

import pcm.allocation.util.AllocationValidator;
 ...
 * </p>
 * <ul>
 *   <li>{@link pcm.allocation.impl.AllocationImpl#getTargetResourceEnvironment_Allocation <em>Target Resource Environment Allocation</em>}</li>
 *   <li>{@link pcm.allocation.impl.AllocationImpl#getSystem_Allocation <em>System Allocation</em>}</li>
 *   <li>{@link pcm.allocation.impl.AllocationImpl#getAllocationContexts_Allocation <em>Allocation Contexts Allocation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AllocationImpl extends EntityImpl implements Allocation {
	 ...
	 * @ordered
	 */
	protected pcm.system.System system_Allocation;
	 ...
	 */
	@Override
	public pcm.system.System getSystem_Allocation() {
		if (system_Allocation != null && system_Allocation.eIsProxy()) {
			...
			system_Allocation = (pcm.system.System)eResolveProxy(oldSystem_Allocation);
	 ...
	 * @generated
	 */
	public pcm.system.System basicGetSystem_Allocation() {
		return system_Allocation;
	}
	 ...
	 */
	@Override
	public void setSystem_Allocation(pcm.system.System newSystem_Allocation) {
		pcm.system.System oldSystem_Allocation = system_Allocation;
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "validateEachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnce", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case AllocationPackage.ALLOCATION__TARGET_RESOURCE_ENVIRONMENT_ALLOCATION:
				...
				return;
			case AllocationPackage.ALLOCATION__SYSTEM_ALLOCATION:
				setSystem_Allocation((pcm.system.System)newValue);
				return;
			case AllocationPackage.ALLOCATION__ALLOCATION_CONTEXTS_ALLOCATION:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case AllocationPackage.ALLOCATION__TARGET_RESOURCE_ENVIRONMENT_ALLOCATION:
				...
				return;
			case AllocationPackage.ALLOCATION__SYSTEM_ALLOCATION:
				setSystem_Allocation((pcm.system.System)null);
				return;
			case AllocationPackage.ALLOCATION__ALLOCATION_CONTEXTS_ALLOCATION:
				getAllocationContexts_Allocation().clear();
				return;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case AllocationPackage.ALLOCATION___VALIDATE_EACH_ASSEMBLY_CONTEXT_WITHIN_SYSTEM_HAS_TO_BE_ALLOCATED_EXACTLY_ONCE__DIAGNOSTICCHAIN_MAP:
				return validateEachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnce((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
