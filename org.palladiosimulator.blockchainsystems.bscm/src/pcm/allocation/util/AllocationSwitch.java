	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AllocationPackage.ALLOCATION_CONTEXT: {
				...
				if (result == null) result = casePCMBaseClass(allocationContext);
				if (result == null) result = casePCMClass(allocationContext);
			...
			case AllocationPackage.ALLOCATION: {
				...
				if (result == null) result = casePCMBaseClass(allocation);
				if (result == null) result = casePCMClass(allocation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
