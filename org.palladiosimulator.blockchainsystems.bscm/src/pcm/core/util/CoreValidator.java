...
public class CoreValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "pcm.core";
	...
	/**
	 * The cached validation expression for the specificationMustNotBeNULL constraint of '<em>PCM Random Variable</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public boolean validatePCMRandomVariable_specificationMustNotBeNULL(PCMRandomVariable pcmRandomVariable, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(CorePackage.Literals.PCM_RANDOM_VARIABLE,
				 pcmRandomVariable,
				 diagnostics,
				 context,
