 ...
 * </p>
 * <ul>
 *   <li>{@link pcm.core.entity.InterfaceProvidingEntity#getProvidedRoles_InterfaceProvidingEntity <em>Provided Roles Interface Providing Entity</em>}</li>
 * </ul>
 *
 * @see pcm.core.entity.EntityPackage#getInterfaceProvidingEntity()
 * @model abstract="true"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='needID'"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/LPG needID='self.id&lt;&gt;null and not (self.id=\'\')'"
 * @generated
 */
public interface InterfaceProvidingEntity extends Entity {
	 ...
	 * The list contents are of type {@link pcm.repository.ProvidedRole}.
	 * It is bidirectional and its opposite is '{@link pcm.repository.ProvidedRole#getProvidingEntity_ProvidedRole <em>Providing Entity Provided Role</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Provided Roles Interface Providing Entity</em>' containment reference list.
	 * @see pcm.core.entity.EntityPackage#getInterfaceProvidingEntity_ProvidedRoles_InterfaceProvidingEntity()
