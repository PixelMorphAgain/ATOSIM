...
public class EntityPackageImpl extends EPackageImpl implements EntityPackage {
	 ...
	 * @see pcm.core.entity.EntityPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		namedElementEClass.getESuperTypes().add(thePcmPackage.getPCMBaseClass());
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (composedProvidingRequiringEntityEClass,
		   source,
		   new String[] {
			   "constraints", "operationProvidedRolesMustBeBound"
		   });
	}
