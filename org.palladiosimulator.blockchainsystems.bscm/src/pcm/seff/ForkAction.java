 ...
 * </p>
 * <ul>
 *   <li>{@link pcm.seff.ForkAction#getAsynchronousForkedBehaviours_ForkAction <em>Asynchronous Forked Behaviours Fork Action</em>}</li>
 *   <li>{@link pcm.seff.ForkAction#getSynchronisingBehaviours_ForkAction <em>Synchronising Behaviours Fork Action</em>}</li>
 * </ul>
 *
 * @see pcm.seff.SeffPackage#getForkAction()
 * @model
 * @generated
 */
public interface ForkAction extends AbstractInternalControlFlowAction {
	 ...
	 * It is bidirectional and its opposite is '{@link pcm.seff.ForkedBehaviour#getForkAction_ForkedBehaivour <em>Fork Action Forked Behaivour</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Asynchronous Forked Behaviours Fork Action</em>' containment reference list.
	 * @see pcm.seff.SeffPackage#getForkAction_AsynchronousForkedBehaviours_ForkAction()
	 ...
	 * It is bidirectional and its opposite is '{@link pcm.seff.SynchronisationPoint#getForkAction_SynchronisationPoint <em>Fork Action Synchronisation Point</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see pcm.seff.SeffPackage#getForkAction_SynchronisingBehaviours_ForkAction()
	...
	/**
	 * Sets the value of the '{@link pcm.seff.ForkAction#getSynchronisingBehaviours_ForkAction <em>Synchronising Behaviours Fork Action</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
