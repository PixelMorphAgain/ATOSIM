 ...
 * </p>
 * <ul>
 *   <li>{@link pcm.seff.AcquireAction#getPassiveresource_AcquireAction <em>Passiveresource Acquire Action</em>}</li>
 *   <li>{@link pcm.seff.AcquireAction#isTimeout <em>Timeout</em>}</li>
 *   <li>{@link pcm.seff.AcquireAction#getTimeoutValue <em>Timeout Value</em>}</li>
 * </ul>
 *
 * @see pcm.seff.SeffPackage#getAcquireAction()
 * @model annotation="http://www.eclipse.org/emf/2002/Ecore constraints='timeoutValueOfAcquireActionMustNotBeNegative'"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/LPG timeoutValueOfAcquireActionMustNotBeNegative='self.timeoutValue.oclAsType(Real) &gt;= 0.0'"
 * @generated
 */
public interface AcquireAction extends AbstractInternalControlFlowAction {
	 ...
	 * @see pcm.seff.SeffPackage#getAcquireAction_Passiveresource_AcquireAction()
	...
	/**
	 * Sets the value of the '{@link pcm.seff.AcquireAction#getPassiveresource_AcquireAction <em>Passiveresource Acquire Action</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see pcm.seff.SeffPackage#getAcquireAction_Timeout()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	boolean isTimeout();
	...
	/**
	 * Sets the value of the '{@link pcm.seff.AcquireAction#isTimeout <em>Timeout</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see pcm.seff.SeffPackage#getAcquireAction_TimeoutValue()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link pcm.seff.AcquireAction#getTimeoutValue <em>Timeout Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
