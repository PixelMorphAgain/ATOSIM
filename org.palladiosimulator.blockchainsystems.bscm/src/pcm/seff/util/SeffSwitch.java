...
import pcm.seff.seff_reliability.FailureHandlingEntity;
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SeffPackage.STOP_ACTION: {
				...
				if (result == null) result = casePCMBaseClass(stopAction);
				if (result == null) result = casePCMClass(stopAction);
			...
			case SeffPackage.ABSTRACT_INTERNAL_CONTROL_FLOW_ACTION: {
				...
				if (result == null) result = casePCMBaseClass(abstractInternalControlFlowAction);
				if (result == null) result = casePCMClass(abstractInternalControlFlowAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.ABSTRACT_ACTION: {
				...
				if (result == null) result = casePCMBaseClass(abstractAction);
				if (result == null) result = casePCMClass(abstractAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.RESOURCE_DEMANDING_BEHAVIOUR: {
				...
				if (result == null) result = casePCMBaseClass(resourceDemandingBehaviour);
				if (result == null) result = casePCMClass(resourceDemandingBehaviour);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.ABSTRACT_LOOP_ACTION: {
				...
				if (result == null) result = casePCMBaseClass(abstractLoopAction);
				if (result == null) result = casePCMClass(abstractLoopAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.ABSTRACT_BRANCH_TRANSITION: {
				...
				if (result == null) result = casePCMBaseClass(abstractBranchTransition);
				if (result == null) result = casePCMClass(abstractBranchTransition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.BRANCH_ACTION: {
				...
				if (result == null) result = casePCMBaseClass(branchAction);
				if (result == null) result = casePCMClass(branchAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.CALL_ACTION: {
				...
				if (result == null) result = casePCMBaseClass(callAction);
				if (result == null) result = casePCMClass(callAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.START_ACTION: {
				...
				if (result == null) result = casePCMBaseClass(startAction);
				if (result == null) result = casePCMClass(startAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SeffPackage.RESOURCE_DEMANDING_SEFF: {
				...
				if (result == null) result = casePCMBaseClass(resourceDemandingSEFF);
				if (result == null) result = casePCMClass(resourceDemandingSEFF);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR: {
				...
				if (result == null) result = casePCMBaseClass(resourceDemandingInternalBehaviour);
				if (result == null) result = casePCMClass(resourceDemandingInternalBehaviour);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.RELEASE_ACTION: {
				...
				if (result == null) result = casePCMBaseClass(releaseAction);
				if (result == null) result = casePCMClass(releaseAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.LOOP_ACTION: {
				...
				if (result == null) result = casePCMBaseClass(loopAction);
				if (result == null) result = casePCMClass(loopAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.FORK_ACTION: {
				...
				if (result == null) result = casePCMBaseClass(forkAction);
				if (result == null) result = casePCMClass(forkAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.FORKED_BEHAVIOUR: {
				...
				if (result == null) result = casePCMBaseClass(forkedBehaviour);
				if (result == null) result = casePCMClass(forkedBehaviour);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.SYNCHRONISATION_POINT: {
				...
				if (result == null) result = casePCMBaseClass(synchronisationPoint);
				if (result == null) result = casePCMClass(synchronisationPoint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.EXTERNAL_CALL_ACTION: {
				...
				if (result == null) result = casePCMBaseClass(externalCallAction);
				if (result == null) result = casePCMClass(externalCallAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.CALL_RETURN_ACTION: {
				...
				if (result == null) result = casePCMBaseClass(callReturnAction);
				if (result == null) result = casePCMClass(callReturnAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.PROBABILISTIC_BRANCH_TRANSITION: {
				...
				if (result == null) result = casePCMBaseClass(probabilisticBranchTransition);
				if (result == null) result = casePCMClass(probabilisticBranchTransition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.ACQUIRE_ACTION: {
				...
				if (result == null) result = casePCMBaseClass(acquireAction);
				if (result == null) result = casePCMClass(acquireAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.COLLECTION_ITERATOR_ACTION: {
				...
				if (result == null) result = casePCMBaseClass(collectionIteratorAction);
				if (result == null) result = casePCMClass(collectionIteratorAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.GUARDED_BRANCH_TRANSITION: {
				...
				if (result == null) result = casePCMBaseClass(guardedBranchTransition);
				if (result == null) result = casePCMClass(guardedBranchTransition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.SET_VARIABLE_ACTION: {
				...
				if (result == null) result = casePCMBaseClass(setVariableAction);
				if (result == null) result = casePCMClass(setVariableAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.INTERNAL_CALL_ACTION: {
				...
				if (result == null) result = casePCMBaseClass(internalCallAction);
				if (result == null) result = casePCMClass(internalCallAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.EMIT_EVENT_ACTION: {
				...
				if (result == null) result = casePCMBaseClass(emitEventAction);
				if (result == null) result = casePCMClass(emitEventAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeffPackage.INTERNAL_ACTION: {
				...
				if (result == null) result = casePCMBaseClass(internalAction);
				if (result == null) result = casePCMClass(internalAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
