 ...
 * </p>
 * <ul>
 *   <li>{@link pcm.seff.ExternalCallAction#getCalledService_ExternalService <em>Called Service External Service</em>}</li>
 *   <li>{@link pcm.seff.ExternalCallAction#getRole_ExternalService <em>Role External Service</em>}</li>
 *   <li>{@link pcm.seff.ExternalCallAction#getRetryCount <em>Retry Count</em>}</li>
 * </ul>
 *
 * @see pcm.seff.SeffPackage#getExternalCallAction()
 * @model annotation="http://www.eclipse.org/emf/2002/Ecore constraints='signatureBelongsToRole operationRequiredRoleMustBeReferencedByContainer'"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/LPG signatureBelongsToRole='self.role_ExternalService.requiredInterface__OperationRequiredRole.signatures__OperationInterface-&gt;includes(self.calledService_ExternalService)' operationRequiredRoleMustBeReferencedByContainer='self.oclAsType(ecore::EObject)-&gt;closure(eContainer())-&gt;select( entity | entity.oclIsKindOf(pcm::core::entity::InterfaceRequiringEntity)).oclAsType(pcm::core::entity::InterfaceRequiringEntity).requiredRoles_InterfaceRequiringEntity-&gt;includes(self.role_ExternalService)'"
 * @generated
 */
public interface ExternalCallAction extends AbstractAction, CallReturnAction, FailureHandlingEntity {
	 ...
	 * @see pcm.seff.SeffPackage#getExternalCallAction_CalledService_ExternalService()
	...
	/**
	 * Sets the value of the '{@link pcm.seff.ExternalCallAction#getCalledService_ExternalService <em>Called Service External Service</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see pcm.seff.SeffPackage#getExternalCallAction_Role_ExternalService()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link pcm.seff.ExternalCallAction#getRole_ExternalService <em>Role External Service</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see pcm.seff.SeffPackage#getExternalCallAction_RetryCount()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	int getRetryCount();
	...
	/**
	 * Sets the value of the '{@link pcm.seff.ExternalCallAction#getRetryCount <em>Retry Count</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
