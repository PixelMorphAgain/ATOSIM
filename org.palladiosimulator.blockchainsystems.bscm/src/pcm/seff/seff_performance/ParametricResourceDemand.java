 ...
 * </p>
 * <ul>
 *   <li>{@link pcm.seff.seff_performance.ParametricResourceDemand#getSpecification_ParametericResourceDemand <em>Specification Parameteric Resource Demand</em>}</li>
 *   <li>{@link pcm.seff.seff_performance.ParametricResourceDemand#getRequiredResource_ParametricResourceDemand <em>Required Resource Parametric Resource Demand</em>}</li>
 *   <li>{@link pcm.seff.seff_performance.ParametricResourceDemand#getAction_ParametricResourceDemand <em>Action Parametric Resource Demand</em>}</li>
 * </ul>
 *
 * @see pcm.seff.seff_performance.Seff_performancePackage#getParametricResourceDemand()
 * @model annotation="http://www.eclipse.org/emf/2002/Ecore constraints='demandedProcessingResourceMustBeUniqueWithinAbstractInternalControlFlowAction'"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/LPG demandedProcessingResourceMustBeUniqueWithinAbstractInternalControlFlowAction='self.action_ParametricResourceDemand.resourceDemand_Action-&gt;select(prd | prd.requiredResource_ParametricResourceDemand=self.requiredResource_ParametricResourceDemand)-&gt;size() = 1'"
 * @generated
 */
public interface ParametricResourceDemand extends PCMBaseClass {
	 ...
	 * It is bidirectional and its opposite is '{@link pcm.core.PCMRandomVariable#getParametricResourceDemand_PCMRandomVariable <em>Parametric Resource Demand PCM Random Variable</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see pcm.seff.seff_performance.Seff_performancePackage#getParametricResourceDemand_Specification_ParametericResourceDemand()
	...
	/**
	 * Sets the value of the '{@link pcm.seff.seff_performance.ParametricResourceDemand#getSpecification_ParametericResourceDemand <em>Specification Parameteric Resource Demand</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see pcm.seff.seff_performance.Seff_performancePackage#getParametricResourceDemand_RequiredResource_ParametricResourceDemand()
	...
	/**
	 * Sets the value of the '{@link pcm.seff.seff_performance.ParametricResourceDemand#getRequiredResource_ParametricResourceDemand <em>Required Resource Parametric Resource Demand</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link pcm.seff.AbstractInternalControlFlowAction#getResourceDemand_Action <em>Resource Demand Action</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see pcm.seff.seff_performance.Seff_performancePackage#getParametricResourceDemand_Action_ParametricResourceDemand()
	...
	/**
	 * Sets the value of the '{@link pcm.seff.seff_performance.ParametricResourceDemand#getAction_ParametricResourceDemand <em>Action Parametric Resource Demand</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
