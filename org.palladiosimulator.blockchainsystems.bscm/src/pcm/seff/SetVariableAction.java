 ...
 * </p>
 * <ul>
 *   <li>{@link pcm.seff.SetVariableAction#getLocalVariableUsages_SetVariableAction <em>Local Variable Usages Set Variable Action</em>}</li>
 * </ul>
 *
 * @see pcm.seff.SeffPackage#getSetVariableAction()
 * @model
 * @generated
 */
public interface SetVariableAction extends AbstractInternalControlFlowAction {
	 ...
	 * It is bidirectional and its opposite is '{@link pcm.parameter.VariableUsage#getSetVariableAction_VariableUsage <em>Set Variable Action Variable Usage</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Local Variable Usages Set Variable Action</em>' containment reference list.
	 * @see pcm.seff.SeffPackage#getSetVariableAction_LocalVariableUsages_SetVariableAction()
