...
public interface SystemPackage extends EPackage {
	 ...
	 * @generated
	 */
	SystemPackage eINSTANCE = pcm.system.impl.SystemPackageImpl.init();

	/**
	 * The meta object id for the '{@link pcm.system.impl.SystemImpl <em>System</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see pcm.system.impl.SystemImpl
	 * @see pcm.system.impl.SystemPackageImpl#getSystem()
	 * @generated
	 */
	int SYSTEM = 0;
	 ...
	 * @ordered
	 */
	int SYSTEM___ECLASS = EntityPackage.ENTITY___ECLASS;
	 ...
	 * @ordered
	 */
	int SYSTEM___EIS_PROXY = EntityPackage.ENTITY___EIS_PROXY;
	 ...
	 * @ordered
	 */
	int SYSTEM___ERESOURCE = EntityPackage.ENTITY___ERESOURCE;
	 ...
	 * @ordered
	 */
	int SYSTEM___ECONTAINER = EntityPackage.ENTITY___ECONTAINER;
	 ...
	 * @ordered
	 */
	int SYSTEM___ECONTAINING_FEATURE = EntityPackage.ENTITY___ECONTAINING_FEATURE;
	 ...
	 * @ordered
	 */
	int SYSTEM___ECONTAINMENT_FEATURE = EntityPackage.ENTITY___ECONTAINMENT_FEATURE;
	 ...
	 * @ordered
	 */
	int SYSTEM___ECONTENTS = EntityPackage.ENTITY___ECONTENTS;
	 ...
	 * @ordered
	 */
	int SYSTEM___EALL_CONTENTS = EntityPackage.ENTITY___EALL_CONTENTS;
	 ...
	 * @ordered
	 */
	int SYSTEM___ECROSS_REFERENCES = EntityPackage.ENTITY___ECROSS_REFERENCES;
	 ...
	 * @ordered
	 */
	int SYSTEM___EGET__ESTRUCTURALFEATURE = EntityPackage.ENTITY___EGET__ESTRUCTURALFEATURE;
	 ...
	 * @ordered
	 */
	int SYSTEM___EGET__ESTRUCTURALFEATURE_BOOLEAN = EntityPackage.ENTITY___EGET__ESTRUCTURALFEATURE_BOOLEAN;
	 ...
	 * @ordered
	 */
	int SYSTEM___ESET__ESTRUCTURALFEATURE_OBJECT = EntityPackage.ENTITY___ESET__ESTRUCTURALFEATURE_OBJECT;
	 ...
	 * @ordered
	 */
	int SYSTEM___EIS_SET__ESTRUCTURALFEATURE = EntityPackage.ENTITY___EIS_SET__ESTRUCTURALFEATURE;
	 ...
	 * @ordered
	 */
	int SYSTEM___EUNSET__ESTRUCTURALFEATURE = EntityPackage.ENTITY___EUNSET__ESTRUCTURALFEATURE;
	 ...
	 * @ordered
	 */
	int SYSTEM___EINVOKE__EOPERATION_ELIST = EntityPackage.ENTITY___EINVOKE__EOPERATION_ELIST;
	 ...
	 * @ordered
	 */
	int SYSTEM___VALIDATE_SAME_SUBSYSTEM_MUST_NOT_BE_INSTANTIATED_MORE_THAN_ONCE__DIAGNOSTICCHAIN_MAP = EntityPackage.ENTITY_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SYSTEM_OPERATION_COUNT = EntityPackage.ENTITY_OPERATION_COUNT + 1;


	/**
	 * Returns the meta object for class '{@link pcm.system.System <em>System</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>System</em>'.
	 * @see pcm.system.System
	 * @generated
	 */
	EClass getSystem();

	/**
	 * Returns the meta object for the containment reference list '{@link pcm.system.System#getQosAnnotations_System <em>Qos Annotations System</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link pcm.system.impl.SystemImpl <em>System</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see pcm.system.impl.SystemImpl
		 * @see pcm.system.impl.SystemPackageImpl#getSystem()
