...
import pcm.system.util.SystemValidator;
...
public class SystemPackageImpl extends EPackageImpl implements SystemPackage {
	 ...
	 * @see pcm.system.SystemPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(systemEClass, pcm.system.System.class, "System", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSystem_QosAnnotations_System(), theQosannotationsPackage.getQoSAnnotations(), theQosannotationsPackage.getQoSAnnotations_System_QoSAnnotations(), "qosAnnotations_System", null, 0, -1, pcm.system.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (systemEClass,
		   source,
		   new String[] {
			   "constraints", "systemMustHaveAtLeastOneProvidedRole"
		   });
	}
	...
	protected void createLPGAnnotations() {
		...
		addAnnotation
		  (systemEClass,
		   source,
		   new String[] {
			   "systemMustHaveAtLeastOneProvidedRole", "not self.providedRoles_InterfaceProvidingEntity->isEmpty()"
		   });
	}
