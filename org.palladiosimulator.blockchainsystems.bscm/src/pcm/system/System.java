 ...
 * </p>
 * <ul>
 *   <li>{@link pcm.system.System#getQosAnnotations_System <em>Qos Annotations System</em>}</li>
 * </ul>
 *
 * @see pcm.system.SystemPackage#getSystem()
 * @model annotation="http://www.eclipse.org/emf/2002/Ecore constraints='systemMustHaveAtLeastOneProvidedRole'"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/LPG systemMustHaveAtLeastOneProvidedRole='not self.providedRoles_InterfaceProvidingEntity-&gt;isEmpty()'"
 * @generated
 */
public interface System extends Entity, ComposedProvidingRequiringEntity {
	 ...
	 * The list contents are of type {@link pcm.qosannotations.QoSAnnotations}.
	 * It is bidirectional and its opposite is '{@link pcm.qosannotations.QoSAnnotations#getSystem_QoSAnnotations <em>System Qo SAnnotations</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see pcm.system.SystemPackage#getSystem_QosAnnotations_System()
