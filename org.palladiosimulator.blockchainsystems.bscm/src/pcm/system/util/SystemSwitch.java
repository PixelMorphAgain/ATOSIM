...
public class SystemSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SystemPackage.SYSTEM: {
				pcm.system.System system = (pcm.system.System)theEObject;
	 ...
	 * @generated
	 */
	public T caseSystem(pcm.system.System object) {
		return null;
	}
