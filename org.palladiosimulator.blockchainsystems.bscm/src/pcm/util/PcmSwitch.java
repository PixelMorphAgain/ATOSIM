...
public class PcmSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PcmPackage.PCM_BASE_CLASS: {
				PCMBaseClass pcmBaseClass = (PCMBaseClass)theEObject;
				T result = casePCMBaseClass(pcmBaseClass);
				if (result == null) result = casePCMClass(pcmBaseClass);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PcmPackage.PCM_CLASS: {
				PCMClass pcmClass = (PCMClass)theEObject;
				T result = casePCMClass(pcmClass);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PcmPackage.DUMMY_CLASS: {
				...
				if (result == null) result = casePCMBaseClass(dummyClass);
				if (result == null) result = casePCMClass(dummyClass);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
