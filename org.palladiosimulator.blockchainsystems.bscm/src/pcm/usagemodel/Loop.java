 ...
 * </p>
 * <ul>
 *   <li>{@link pcm.usagemodel.Loop#getLoopIteration_Loop <em>Loop Iteration Loop</em>}</li>
 *   <li>{@link pcm.usagemodel.Loop#getBodyBehaviour_Loop <em>Body Behaviour Loop</em>}</li>
 * </ul>
 *
 * @see pcm.usagemodel.UsagemodelPackage#getLoop()
 * @model
 * @generated
 */
public interface Loop extends AbstractUserAction {
	 ...
	 * It is bidirectional and its opposite is '{@link pcm.core.PCMRandomVariable#getLoop_LoopIteration <em>Loop Loop Iteration</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Loop Iteration Loop</em>' containment reference.
	 * @see #setLoopIteration_Loop(PCMRandomVariable)
	 * @see pcm.usagemodel.UsagemodelPackage#getLoop_LoopIteration_Loop()
	...
	/**
	 * Sets the value of the '{@link pcm.usagemodel.Loop#getLoopIteration_Loop <em>Loop Iteration Loop</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link pcm.usagemodel.ScenarioBehaviour#getLoop_ScenarioBehaviour <em>Loop Scenario Behaviour</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Body Behaviour Loop</em>' containment reference.
	 * @see #setBodyBehaviour_Loop(ScenarioBehaviour)
	 * @see pcm.usagemodel.UsagemodelPackage#getLoop_BodyBehaviour_Loop()
	...
	/**
	 * Sets the value of the '{@link pcm.usagemodel.Loop#getBodyBehaviour_Loop <em>Body Behaviour Loop</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
