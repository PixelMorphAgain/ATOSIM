 ...
 * </p>
 * <ul>
 *   <li>{@link pcm.usagemodel.Workload#getUsageScenario_Workload <em>Usage Scenario Workload</em>}</li>
 * </ul>
 *
 * @see pcm.usagemodel.UsagemodelPackage#getWorkload()
 * @model abstract="true"
 * @generated
 */
public interface Workload extends PCMBaseClass {
	 ...
	 * It is bidirectional and its opposite is '{@link pcm.usagemodel.UsageScenario#getWorkload_UsageScenario <em>Workload Usage Scenario</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Usage Scenario Workload</em>' container reference.
	 * @see #setUsageScenario_Workload(UsageScenario)
	 * @see pcm.usagemodel.UsagemodelPackage#getWorkload_UsageScenario_Workload()
	...
	/**
	 * Sets the value of the '{@link pcm.usagemodel.Workload#getUsageScenario_Workload <em>Usage Scenario Workload</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
