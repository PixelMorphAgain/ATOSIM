 ...
 * </p>
 * <ul>
 *   <li>{@link pcm.resourcetype.ResourceSignature#getParameter__ResourceSignature <em>Parameter Resource Signature</em>}</li>
 *   <li>{@link pcm.resourcetype.ResourceSignature#getResourceServiceId <em>Resource Service Id</em>}</li>
 *   <li>{@link pcm.resourcetype.ResourceSignature#getResourceInterface__ResourceSignature <em>Resource Interface Resource Signature</em>}</li>
 * </ul>
 *
 * @see pcm.resourcetype.ResourcetypePackage#getResourceSignature()
 * @model
 * @generated
 */
public interface ResourceSignature extends Entity {
	 ...
	 * It is bidirectional and its opposite is '{@link pcm.repository.Parameter#getResourceSignature__Parameter <em>Resource Signature Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Parameter Resource Signature</em>' containment reference list.
	 * @see pcm.resourcetype.ResourcetypePackage#getResourceSignature_Parameter__ResourceSignature()
	 ...
	 * @see pcm.resourcetype.ResourcetypePackage#getResourceSignature_ResourceServiceId()
	...
	/**
	 * Sets the value of the '{@link pcm.resourcetype.ResourceSignature#getResourceServiceId <em>Resource Service Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link pcm.resourcetype.ResourceInterface#getResourceSignatures__ResourceInterface <em>Resource Signatures Resource Interface</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see pcm.resourcetype.ResourcetypePackage#getResourceSignature_ResourceInterface__ResourceSignature()
	...
	/**
	 * Sets the value of the '{@link pcm.resourcetype.ResourceSignature#getResourceInterface__ResourceSignature <em>Resource Interface Resource Signature</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
