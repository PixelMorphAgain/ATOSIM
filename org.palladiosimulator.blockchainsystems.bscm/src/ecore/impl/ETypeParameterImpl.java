 ...
 * </p>
 * <ul>
 *   <li>{@link ecore.impl.ETypeParameterImpl#getEBounds <em>EBounds</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ETypeParameterImpl extends ENamedElementImpl implements ETypeParameter {
	...
	public EList<EGenericType> getEBounds() {
		if (eBounds == null) {
			eBounds = new EObjectContainmentEList<EGenericType>(EGenericType.class, this, EcorePackage.ETYPE_PARAMETER__EBOUNDS);
		}
		return eBounds;
	}
