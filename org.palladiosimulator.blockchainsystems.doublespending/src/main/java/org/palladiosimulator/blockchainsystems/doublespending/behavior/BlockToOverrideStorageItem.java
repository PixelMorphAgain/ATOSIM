...
public class BlockToOverrideStorageItem {
    ...
    private static final Comparator<Block> BLOCK_COMPARATOR = Comparator.comparingLong(Block::getBlockMinedTimestamp);
    ...
    public void addBlock(Block block) {
        if (!Objects.equals(block.getPreviousHash(), _attackOriginBlockHash)) return;
