...
public class SimulationTerminationTab extends AbstractLaunchConfigurationTab {
	...
	private void createMaxChainLengthInputGroup(Composite parent) {
        ...
        _maxBlockchainLengthLabel.setText("Maximum Blockchain Length must be bigger or equal to " + MINIMUM_ALLOWED_BLOCKCHAIN_LENGTH +" and smaller or equal to " + MAXIMUM_ALLOWED_BLOCKCHAIN_LENGTH + ".");
